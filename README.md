...
Before building from source, ensure you have the latest [Go 1.19.0+](https://golang.org/dl/) and latest [Protocol Buffers](https://github.com/protocolbuffers/protobuf/releases).  
...
Some files in this repo are auto-generated. Whenever a proto or resource pack is changed, these will need to be rebuilt. To re-run:
...
[Mozilla Public License v2.0](https://github.com/mondoohq/cnspec/blob/main/LICENSE)
