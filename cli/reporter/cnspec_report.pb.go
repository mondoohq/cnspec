...
const file_cnspec_report_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2#.mondoo.report.cnspec.v1.ScoreValueR\x05value:\x028\x01\":\n" +
	"\n" +
	"ScoreValue\x12\x14\n" +
	"\x05score\x18\x01 \x01(\rR\x05score\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06statusB'Z%go.mondoo.com/cnspec/v12/cli/reporterb\x06proto3"
