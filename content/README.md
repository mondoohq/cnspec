...
- **Kubernetes Network Posture** - `mondoo-kubernetes-network-posture.mql.yaml` - Kubernetes Service, Ingress, Gateway API, egress, NAT, and network policy coverage visibility
