resource "azurerm_firewall" "example" {
  ...
  sku_name            = "AZFW_VNet"
  sku_tier            = "Premium"
  firewall_policy_id  = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/example-rg/providers/Microsoft.Network/firewallPolicies/example-policy"
