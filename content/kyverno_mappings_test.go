...
func kyvernoContentRuntime(t *testing.T) *providers.Runtime {
	...
	schema.Add("core", testutils.MustLoadSchema(testutils.SchemaProvider{Path: kyvernoCoreSchemaPath(t)}))
	schema.Add("network", testutils.MustLoadSchema(testutils.SchemaProvider{Path: kyvernoNetworkSchemaPath(t)}))
	schema.Add("os", testutils.MustLoadSchema(testutils.SchemaProvider{Path: kyvernoOSSchemaPath(t)}))
	schema.Add("k8s", testutils.MustLoadSchema(testutils.SchemaProvider{Path: kyvernoK8sSchemaPath(t)}))
	return runtime
}
...
func kyvernoK8sSchemaPath(t *testing.T) string {
	t.Helper()
...
func kyvernoCoreSchemaPath(t *testing.T) string {
	t.Helper()
...
func kyvernoNetworkSchemaPath(t *testing.T) string {
	t.Helper()
...
func kyvernoOSSchemaPath(t *testing.T) string {
	t.Helper()
