...
# declare them, live in `upstream_pins.py`. This script only renders them; its
# sibling `bump_upstream_versions.py` rewrites them.
#
...
#   python3 content/validation/check_upstream_versions.py --format json
...
from upstream_pins import Pin, discover  # noqa: E402
