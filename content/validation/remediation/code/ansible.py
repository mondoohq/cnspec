...
#
# Usage:
#   python3 content/validation/remediation/code/ansible.py                  # validate all
#   python3 content/validation/remediation/code/ansible.py linux            # validate Linux only
#   python3 content/validation/remediation/code/ansible.py windows          # validate Windows only
#   python3 content/validation/remediation/code/ansible.py --github-actions # emit GH annotations
...
TARGETS = {
    ...
    "ai": [CONTENT_DIR / "mondoo-ai-security.mql.yaml"],
