...
#
# Usage:
#   python3 content/validation/remediation/code/bash.py                  # validate all
#   python3 content/validation/remediation/code/bash.py linux            # validate Linux only
#   python3 content/validation/remediation/code/bash.py --github-actions # emit GH annotations
...
# (`remediation/code/bash.py linux`), not as a definition of what CI covers.
TARGETS = {
    "linux": [
