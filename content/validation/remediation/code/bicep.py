...
#
# Mirrors remediation/code/cloudformation.py: extract the fenced blocks
# from one `- id:`, make each snippet stand on its own, run the ecosystem's own
# compiler over it.
#
# Usage: python3 content/validation/remediation/code/bicep.py [azure|m365] [--github-actions]
