...
#
# Usage:
#   python3 content/validation/remediation/code/chef.py                  # validate all
#   python3 content/validation/remediation/code/chef.py linux            # validate Linux only
#   python3 content/validation/remediation/code/chef.py chef             # validate Chef policies only
#   python3 content/validation/remediation/code/chef.py --github-actions # emit GH annotations
...
TARGETS = {
    ...
    "chef": [
        CONTENT_DIR / "mondoo-chef-infra-client.mql.yaml",
        CONTENT_DIR / "mondoo-chef-infra-server.mql.yaml",
    ],
}
