...
#
# Mirrors remediation/code/terraform.py: extract the fenced blocks from one
# `- id:`, make each snippet stand on its own, and run the ecosystem's own
# linter over it.
#
# Usage: python3 content/validation/remediation/code/cloudformation.py [aws] [--github-actions]
