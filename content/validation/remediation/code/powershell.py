...
# a checked-in grammar, the way upstream/dump/azure.py handles the Azure CLI.
#
# Usage:
#   python3 content/validation/remediation/code/powershell.py
#   python3 content/validation/remediation/code/powershell.py windows
#   python3 content/validation/remediation/code/powershell.py --github-actions
