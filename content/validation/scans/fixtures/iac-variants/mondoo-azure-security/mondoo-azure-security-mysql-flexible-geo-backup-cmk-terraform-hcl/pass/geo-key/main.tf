resource "azurerm_mysql_flexible_server" "srv" {
  ...
  customer_managed_key {
    ...
    geo_backup_key_vault_key_id          = "https://geovault.vault.azure.net/keys/geokey/version"
    geo_backup_user_assigned_identity_id = "/subscriptions/000/resourceGroups/rg/providers/Microsoft.ManagedIdentity/userAssignedIdentities/geouai"
  }
}
