...
#
# `upstream/check.py` says which pins are behind; this applies the
...
#
# Usage:
#   python3 content/validation/upstream/bump.py --list
#   python3 content/validation/upstream/bump.py --only cfn-lint
#   python3 content/validation/upstream/bump.py --only terraform-provider
#   python3 content/validation/upstream/bump.py --all --dry-run
#   python3 content/validation/upstream/bump.py --only doctl --json -
