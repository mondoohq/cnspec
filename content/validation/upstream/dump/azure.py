...
#
# Usage: python3 content/validation/upstream/dump/azure.py [--output azure_commands.json]
...
# Keep in sync with what remediation/commands/azure.py reads.
...
def main():
    ...
    # rather than a guess (upstream/check.py compares it against the
    ...
    commands["_meta"] = {
        ...
        "generated_by": "upstream/dump/azure.py",
    }
