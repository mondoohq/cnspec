...
# remediation/commands/validate.py) so the output is deterministic; bumping
...
#   }
#
# Usage: python3 content/validation/upstream/dump/ncli.py [--output data/ncli_commands.json]
...
DEFAULT_OUTPUT = DATA_DIR / "ncli_commands.json"
...
def main():
    ...
    result = {
        "_meta": {
            ...
            "generated_by": "upstream/dump/ncli.py",
        },
