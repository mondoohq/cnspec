...
# discoverable aliases, and valid flags) into data/vercel_commands.json
# for the CLI validator in remediation/commands/vercel.py.
#
...
#   }
#
# Usage: python3 content/validation/upstream/dump/vercel.py [--output data/vercel_commands.json]
...
DEFAULT_OUTPUT = DATA_DIR / "vercel_commands.json"
POLICY_FILE = CONTENT_DIR / "mondoo-vercel-security.mql.yaml"
...
def main():
    ...
    result = {
        "_meta": {
            ...
            "generated_by": "upstream/dump/vercel.py",
        },
