...
<Callout type="warn">
  This tutorial provisions resources that qualify under the AWS Free Tier. If your account doesn't
  qualify under the AWS Free Tier, Mondoo is not responsible for charges that you incur.
</Callout>
### Prerequisites
...
<Callout type="info">
  If you don't have access to IAM user credentials, use another authentication method described in
  the [Packer Amazon AMI Builder
