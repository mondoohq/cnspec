...
<Callout type="warn">
  This tutorial provisions resources in your Google Cloud project. Mondoo is not responsible for
...
<Callout type="info">
  To scan for vulnerabilities, you must register cnspec with Mondoo Platform. [Sign up for a free
  account](https://mondoo.com/pricing) today.
</Callout>
...
<Callout type="info">
  To learn about the various options to override variables set in the Packer template, see [Setting
