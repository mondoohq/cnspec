...
...
    ...
    <image-name>:
    <image-name>: Report URL: https://app.mondoo.com/space/inventory/<space>
...
Packer Plugin Mondoo sends the scan results to your account in Mondoo Platform. To view the scan report in the Mondoo App, navigate to **INVENTORY**, then **ASSETS** and select your asset. You may need to refresh your browser.
