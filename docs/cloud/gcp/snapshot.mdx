...
<Callout type="info">
  You can create a VM instance template to make it easier to spin up VM instances for snapshot
  scanning. To learn how, read [Create instance
  templates](https://cloud.google.com/compute/docs/instance-templates/create-instance-templates) in
