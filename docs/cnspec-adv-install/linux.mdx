...
1. Log into [the Mondoo App](https://app.mondoo.com).
...
Each time the service starts, it runs a local scan based on the selected policies and sends the results to this machine's space in Mondoo Platform. You can then [view the results](/platform/security/posture/monitor/) in the Mondoo App.
