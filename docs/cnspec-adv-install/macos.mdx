...
<Callout type="info">
  The environment variable `MONDOO_REGISTRATION_TOKEN` allows you to pass a
  registration token to the installation package. If provided, the client will
  register automatically during the installation.
</Callout>
