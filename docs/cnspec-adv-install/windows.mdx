...
If your organization's [region](/platform/start/organize/regions/) (in the Mondoo App) is US, you must be able to access us.api.mondoo.com. If your region is EU, you must be able to access eu.api.mondoo.com.
...
If you wish later the scan happens by loading the configured Policy from your Mondoo App space, you need to register by having a registration token which will be given to you during integration from https://app.mondoo.com/.
...
Here the cnspec will automatically load the policies from Mondoo App spaces provided you have registered the mondoo with the token. Otherwise, the policies will be loaded from our registry.
