...
cnspec is now registered with Mondoo Platform. The next time you scan your infrastructure with cnspec, you can see the results in the Mondoo App.

To learn about working in the Mondoo App, see the [Mondoo Platform documentation](/home/).
