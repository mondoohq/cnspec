...
8. Select **Close**.
   ...
   ![Google Service Account Client ID](/img/cnspec/gw/gw-service-account-id.png)
...
![Google Workspace Customer ID](/img/cnspec/gw/gw-customer-id.png)

## Scan Google Workspace

To scan your Google Workspace environment against security policies:

```bash
cnspec scan google-workspace --customer-id 5amp13iD --impersonated-user-email admin@domain.com --credentials-path /home/user/my-project-6646123456789.json
```

| For...                      | Substitute...                                               |
| --------------------------- | ----------------------------------------------------------- |
| `--customer-id`             | The Google Workspace customer ID from the Admin Console     |
