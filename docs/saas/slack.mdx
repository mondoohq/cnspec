---
title: Assess Slack Security with cnspec
sidebar_label: Slack
sidebar_position: 50
...
To scan your Slack workspace against security policies:

```bash
cnspec scan slack --token <api-token>
```

You can also use the `SLACK_TOKEN` environment variable:
