...
<Callout>
  The average scoring system can produce overly positive results for assets that
  fail checks with very high impact scores.
</Callout>
...
<Callout>
  The weighted average scoring system can produce overly positive results for
  assets that fail checks with very high impact scores.
</Callout>
To use the weighted average scoring system, set the `scoring system` value to
`weighted`:
...
<Callout>
  These examples don't include the weighted average scoring policy because its
  behavior is so similar to the average scoring policy.
</Callout>
