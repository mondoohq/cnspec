...
require (
	...
	go.mondoo.com/cnquery/v12 v12.7.1
	go.mondoo.com/mondoo-go v0.0.0-20251022000425-2aa884f9d36b
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ec2instanceconnect v1.32.7 // indirect
