...
require (
	...
	go.mondoo.com/cnquery/v12 v12.11.0
	go.mondoo.com/mondoo-go v0.0.0-20251119000434-95a379b46352
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ec2instanceconnect v1.32.12 // indirect
