...
// the boolean verdict and whether the query resolved to a concrete value.
func (r *RuntimeRunner) Run(query string) (bool, bool, error) {
	bundle, err := mqlc.Compile(query, nil, mqlc.NewConfig(r.runtime.Schema(), r.features))
	if err != nil {
