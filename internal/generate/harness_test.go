...
var goldenReplies = map[string]string{
	...
	"EBS volumes must be encrypted by default":                   "aws.ec2.ebsEncryptionByDefault == true",
	...
	"Managed disks must be encrypted":                            "azure.subscription.compute.disks.all(encryptionSettings != empty)",
