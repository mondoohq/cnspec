...
func (Status) Descriptor() protoreflect.EnumDescriptor {
	return file_cnspec_sbom_proto_enumTypes[0].Descriptor()
}

func (Status) Type() protoreflect.EnumType {
	return &file_cnspec_sbom_proto_enumTypes[0]
}
...
func (Status) EnumDescriptor() ([]byte, []int) {
	return file_cnspec_sbom_proto_rawDescGZIP(), []int{0}
}
...
func (ExternalIDType) Descriptor() protoreflect.EnumDescriptor {
	return file_cnspec_sbom_proto_enumTypes[1].Descriptor()
}

func (ExternalIDType) Type() protoreflect.EnumType {
	return &file_cnspec_sbom_proto_enumTypes[1]
}
...
func (ExternalIDType) EnumDescriptor() ([]byte, []int) {
	return file_cnspec_sbom_proto_rawDescGZIP(), []int{1}
}
...
func (EvidenceType) Descriptor() protoreflect.EnumDescriptor {
	return file_cnspec_sbom_proto_enumTypes[2].Descriptor()
}

func (EvidenceType) Type() protoreflect.EnumType {
	return &file_cnspec_sbom_proto_enumTypes[2]
}
...
func (EvidenceType) EnumDescriptor() ([]byte, []int) {
	return file_cnspec_sbom_proto_rawDescGZIP(), []int{2}
}
...
type Sbom struct {
	...
	Status Status `protobuf:"varint,3,opt,name=status,proto3,enum=mondoo.cnspec.sbom.v1.Status" json:"status,omitempty"`
...
func (x *Sbom) Reset() {
	*x = Sbom{}
	mi := &file_cnspec_sbom_proto_msgTypes[0]
...
func (x *Generator) Reset() {
	*x = Generator{}
	mi := &file_cnspec_sbom_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ExternalID struct {
	...
	Type ExternalIDType `protobuf:"varint,1,opt,name=type,proto3,enum=mondoo.cnspec.sbom.v1.ExternalIDType" json:"type,omitempty"`
...
func (x *ExternalID) Reset() {
	*x = ExternalID{}
	mi := &file_cnspec_sbom_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Asset) Reset() {
	*x = Asset{}
	mi := &file_cnspec_sbom_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Asset) Descriptor() ([]byte, []int) {
	return file_cnspec_sbom_proto_rawDescGZIP(), []int{3}
}
...
func (x *Platform) Reset() {
	*x = Platform{}
	mi := &file_cnspec_sbom_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Platform) Descriptor() ([]byte, []int) {
	return file_cnspec_sbom_proto_rawDescGZIP(), []int{4}
}
...
func (x *Package) Reset() {
	*x = Package{}
	mi := &file_cnspec_sbom_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Package) Descriptor() ([]byte, []int) {
	return file_cnspec_sbom_proto_rawDescGZIP(), []int{5}
}
...
type Evidence struct {
	...
	Type EvidenceType `protobuf:"varint,1,opt,name=type,proto3,enum=mondoo.cnspec.sbom.v1.EvidenceType" json:"type,omitempty"`
...
func (x *Evidence) Reset() {
	*x = Evidence{}
	mi := &file_cnspec_sbom_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Evidence) Descriptor() ([]byte, []int) {
	return file_cnspec_sbom_proto_rawDescGZIP(), []int{6}
}
...
func (x *Kernel) Reset() {
	*x = Kernel{}
	mi := &file_cnspec_sbom_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Kernel) Descriptor() ([]byte, []int) {
	return file_cnspec_sbom_proto_rawDescGZIP(), []int{7}
}
...
var File_cnspec_sbom_proto protoreflect.FileDescriptor

const file_cnspec_sbom_proto_rawDesc = "" +
	"\n" +
	"\x11cnspec_sbom.proto\x12\x15mondoo.cnspec.sbom.v1\"\xb0\x02\n" +
	"\x04Sbom\x12>\n" +
	"\tgenerator\x18\x01 \x01(\v2 .mondoo.cnspec.sbom.v1.GeneratorR\tgenerator\x12\x1c\n" +
	"\ttimestamp\x18\x02 \x01(\tR\ttimestamp\x125\n" +
	"\x06status\x18\x03 \x01(\x0e2\x1d.mondoo.cnspec.sbom.v1.StatusR\x06status\x122\n" +
	"\x05asset\x18\x04 \x01(\v2\x1c.mondoo.cnspec.sbom.v1.AssetR\x05asset\x12:\n" +
	"\bpackages\x18\x05 \x03(\v2\x1e.mondoo.cnspec.sbom.v1.PackageR\bpackages\x12#\n" +
	...
	"\n" +
	"ExternalID\x129\n" +
	"\x04type\x18\x01 \x01(\x0e2%.mondoo.cnspec.sbom.v1.ExternalIDTypeR\x04type\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\"\x92\x03\n" +
	"\x05Asset\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12!\n" +
	"\fplatform_ids\x18\x04 \x03(\tR\vplatformIds\x12D\n" +
	"\fexternal_ids\x18\x05 \x03(\v2!.mondoo.cnspec.sbom.v1.ExternalIDR\vexternalIds\x12;\n" +
	"\bplatform\x18\x06 \x01(\v2\x1f.mondoo.cnspec.sbom.v1.PlatformR\bplatform\x12@\n" +
	"\x06labels\x18\x12 \x03(\v2(.mondoo.cnspec.sbom.v1.Asset.LabelsEntryR\x06labels\x12\x19\n" +
	"\btrace_id\x18\x13 \x01(\tR\atraceId\x127\n" +
	"\akernels\x18\x14 \x03(\v2\x1d.mondoo.cnspec.sbom.v1.KernelR\akernels\x1a9\n" +
	...
	"\aversion\x18\a \x01(\tR\aversion\x12C\n" +
	"\x06labels\x18\x16 \x03(\v2+.mondoo.cnspec.sbom.v1.Platform.LabelsEntryR\x06labels\x12\x12\n" +
	...
	"\vdescription\x18\x14 \x01(\tR\vdescription\x12D\n" +
	"\revidence_list\x18\x15 \x03(\v2\x1f.mondoo.cnspec.sbom.v1.EvidenceR\fevidenceList\x12\x16\n" +
	...
	"\x05title\x18\x19 \x01(\tR\x05title\"Y\n" +
	"\bEvidence\x127\n" +
	"\x04type\x18\x01 \x01(\x0e2#.mondoo.cnspec.sbom.v1.EvidenceTypeR\x04type\x12\x14\n" +
	...
	"\x12EVIDENCE_TYPE_FILE\x10\x01B(Z&go.mondoo.com/cnspec/v12/internal/sbomb\x06proto3"

var (
	file_cnspec_sbom_proto_rawDescOnce sync.Once
	file_cnspec_sbom_proto_rawDescData []byte
)

func file_cnspec_sbom_proto_rawDescGZIP() []byte {
	file_cnspec_sbom_proto_rawDescOnce.Do(func() {
		file_cnspec_sbom_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_cnspec_sbom_proto_rawDesc), len(file_cnspec_sbom_proto_rawDesc)))
	})
	return file_cnspec_sbom_proto_rawDescData
}

var file_cnspec_sbom_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_cnspec_sbom_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_cnspec_sbom_proto_goTypes = []any{
	(Status)(0),         // 0: mondoo.cnspec.sbom.v1.Status
	(ExternalIDType)(0), // 1: mondoo.cnspec.sbom.v1.ExternalIDType
	(EvidenceType)(0),   // 2: mondoo.cnspec.sbom.v1.EvidenceType
	(*Sbom)(nil),        // 3: mondoo.cnspec.sbom.v1.Sbom
	(*Generator)(nil),   // 4: mondoo.cnspec.sbom.v1.Generator
	(*ExternalID)(nil),  // 5: mondoo.cnspec.sbom.v1.ExternalID
	(*Asset)(nil),       // 6: mondoo.cnspec.sbom.v1.Asset
	(*Platform)(nil),    // 7: mondoo.cnspec.sbom.v1.Platform
	(*Package)(nil),     // 8: mondoo.cnspec.sbom.v1.Package
	(*Evidence)(nil),    // 9: mondoo.cnspec.sbom.v1.Evidence
	(*Kernel)(nil),      // 10: mondoo.cnspec.sbom.v1.Kernel
	nil,                 // 11: mondoo.cnspec.sbom.v1.Asset.LabelsEntry
	nil,                 // 12: mondoo.cnspec.sbom.v1.Platform.LabelsEntry
}
var file_cnspec_sbom_proto_depIdxs = []int32{
	4,  // 0: mondoo.cnspec.sbom.v1.Sbom.generator:type_name -> mondoo.cnspec.sbom.v1.Generator
	0,  // 1: mondoo.cnspec.sbom.v1.Sbom.status:type_name -> mondoo.cnspec.sbom.v1.Status
	6,  // 2: mondoo.cnspec.sbom.v1.Sbom.asset:type_name -> mondoo.cnspec.sbom.v1.Asset
	8,  // 3: mondoo.cnspec.sbom.v1.Sbom.packages:type_name -> mondoo.cnspec.sbom.v1.Package
	1,  // 4: mondoo.cnspec.sbom.v1.ExternalID.type:type_name -> mondoo.cnspec.sbom.v1.ExternalIDType
	5,  // 5: mondoo.cnspec.sbom.v1.Asset.external_ids:type_name -> mondoo.cnspec.sbom.v1.ExternalID
	7,  // 6: mondoo.cnspec.sbom.v1.Asset.platform:type_name -> mondoo.cnspec.sbom.v1.Platform
	11, // 7: mondoo.cnspec.sbom.v1.Asset.labels:type_name -> mondoo.cnspec.sbom.v1.Asset.LabelsEntry
	10, // 8: mondoo.cnspec.sbom.v1.Asset.kernels:type_name -> mondoo.cnspec.sbom.v1.Kernel
	12, // 9: mondoo.cnspec.sbom.v1.Platform.labels:type_name -> mondoo.cnspec.sbom.v1.Platform.LabelsEntry
	9,  // 10: mondoo.cnspec.sbom.v1.Package.evidence_list:type_name -> mondoo.cnspec.sbom.v1.Evidence
	2,  // 11: mondoo.cnspec.sbom.v1.Evidence.type:type_name -> mondoo.cnspec.sbom.v1.EvidenceType
...
func init() { file_cnspec_sbom_proto_init() }
func file_cnspec_sbom_proto_init() {
	if File_cnspec_sbom_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_cnspec_sbom_proto_rawDesc), len(file_cnspec_sbom_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cnspec_sbom_proto_goTypes,
		DependencyIndexes: file_cnspec_sbom_proto_depIdxs,
		EnumInfos:         file_cnspec_sbom_proto_enumTypes,
		MessageInfos:      file_cnspec_sbom_proto_msgTypes,
	}.Build()
	File_cnspec_sbom_proto = out.File
	file_cnspec_sbom_proto_goTypes = nil
	file_cnspec_sbom_proto_depIdxs = nil
}
