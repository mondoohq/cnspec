...
const (
	...
	GroupType_RISK_ACCEPTED GroupType = 8
)
...
const file_cnspec_policy_proto_rawDesc = "" +
	...
	"\aunrated\x18\b \x01(\rR\aunrated\"\x8e\x03\n" +
	"\n" +
	"ScoreStats\x12\x16\n" +
	...
	"\x10newest_scan_time\x18\f \x01(\x03R\x0enewestScanTime\"\xa0\x02\n" +
	...
	"\fOUT_OF_SCOPE\x10\a\x12\x11\n" +
	"\rRISK_ACCEPTED\x10\b*H\n" +
