...
var file_cnspec_policy_proto_rawDesc = []byte{
	...
	0x6c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xf7, 0x02, 0x0a, 0x06, 0x42, 0x75, 0x6e, 0x64, 0x6c,
...
var file_cnspec_policy_proto_goTypes = []interface{}{
	...
	(*explorer.ObjectRef)(nil),                  // 91: cnquery.explorer.ObjectRef
	(*explorer.MqueryRef)(nil),                  // 92: cnquery.explorer.MqueryRef
	(*inventory.Platform)(nil),                  // 93: cnquery.providers.v1.Platform
	(*llx.CodeBundle)(nil),                      // 94: cnquery.llx.CodeBundle
	(*inventory.Asset)(nil),                     // 95: cnquery.providers.v1.Asset
...
var file_cnspec_policy_proto_depIdxs = []int32{
	...
	90,  // 19: cnspec.policy.v1.Bundle.props:type_name -> cnquery.explorer.Property
	84,  // 20: cnspec.policy.v1.Bundle.queries:type_name -> cnquery.explorer.Mquery
	16,  // 21: cnspec.policy.v1.Bundle.frameworks:type_name -> cnspec.policy.v1.Framework
	21,  // 22: cnspec.policy.v1.Bundle.framework_maps:type_name -> cnspec.policy.v1.FrameworkMap
	15,  // 23: cnspec.policy.v1.Bundle.docs:type_name -> cnspec.policy.v1.PolicyDocs
	18,  // 24: cnspec.policy.v1.Framework.groups:type_name -> cnspec.policy.v1.FrameworkGroup
	15,  // 25: cnspec.policy.v1.Framework.docs:type_name -> cnspec.policy.v1.PolicyDocs
	86,  // 26: cnspec.policy.v1.Framework.authors:type_name -> cnquery.explorer.Author
	63,  // 27: cnspec.policy.v1.Framework.tags:type_name -> cnspec.policy.v1.Framework.TagsEntry
	19,  // 28: cnspec.policy.v1.Framework.dependencies:type_name -> cnspec.policy.v1.FrameworkRef
	21,  // 29: cnspec.policy.v1.Framework.framework_maps:type_name -> cnspec.policy.v1.FrameworkMap
	16,  // 30: cnspec.policy.v1.Frameworks.items:type_name -> cnspec.policy.v1.Framework
	20,  // 31: cnspec.policy.v1.FrameworkGroup.controls:type_name -> cnspec.policy.v1.Control
	0,   // 32: cnspec.policy.v1.FrameworkGroup.type:type_name -> cnspec.policy.v1.GroupType
	14,  // 33: cnspec.policy.v1.FrameworkGroup.docs:type_name -> cnspec.policy.v1.PolicyGroupDocs
	86,  // 34: cnspec.policy.v1.FrameworkGroup.authors:type_name -> cnquery.explorer.Author
	86,  // 35: cnspec.policy.v1.FrameworkGroup.reviewers:type_name -> cnquery.explorer.Author
	2,   // 36: cnspec.policy.v1.FrameworkGroup.review_status:type_name -> cnspec.policy.v1.ReviewStatus
	87,  // 37: cnspec.policy.v1.FrameworkRef.action:type_name -> cnquery.explorer.Action
	23,  // 38: cnspec.policy.v1.Control.docs:type_name -> cnspec.policy.v1.ControlDocs
	64,  // 39: cnspec.policy.v1.Control.tags:type_name -> cnspec.policy.v1.Control.TagsEntry
	87,  // 40: cnspec.policy.v1.Control.action:type_name -> cnquery.explorer.Action
	91,  // 41: cnspec.policy.v1.FrameworkMap.framework_dependencies:type_name -> cnquery.explorer.ObjectRef
	91,  // 42: cnspec.policy.v1.FrameworkMap.policy_dependencies:type_name -> cnquery.explorer.ObjectRef
	91,  // 43: cnspec.policy.v1.FrameworkMap.query_pack_dependencies:type_name -> cnquery.explorer.ObjectRef
	22,  // 44: cnspec.policy.v1.FrameworkMap.controls:type_name -> cnspec.policy.v1.ControlMap
	91,  // 45: cnspec.policy.v1.FrameworkMap.framework_owner:type_name -> cnquery.explorer.ObjectRef
	24,  // 46: cnspec.policy.v1.ControlMap.checks:type_name -> cnspec.policy.v1.ControlRef
	24,  // 47: cnspec.policy.v1.ControlMap.policies:type_name -> cnspec.policy.v1.ControlRef
	24,  // 48: cnspec.policy.v1.ControlMap.controls:type_name -> cnspec.policy.v1.ControlRef
	24,  // 49: cnspec.policy.v1.ControlMap.queries:type_name -> cnspec.policy.v1.ControlRef
	92,  // 50: cnspec.policy.v1.ControlDocs.refs:type_name -> cnquery.explorer.MqueryRef
	87,  // 51: cnspec.policy.v1.ControlRef.action:type_name -> cnquery.explorer.Action
	93,  // 52: cnspec.policy.v1.Asset.platform:type_name -> cnquery.providers.v1.Platform
	27,  // 53: cnspec.policy.v1.ResolvedPolicy.execution_job:type_name -> cnspec.policy.v1.ExecutionJob
	29,  // 54: cnspec.policy.v1.ResolvedPolicy.collector_job:type_name -> cnspec.policy.v1.CollectorJob
	84,  // 55: cnspec.policy.v1.ResolvedPolicy.filters:type_name -> cnquery.explorer.Mquery
	65,  // 56: cnspec.policy.v1.ExecutionJob.queries:type_name -> cnspec.policy.v1.ExecutionJob.QueriesEntry
	66,  // 57: cnspec.policy.v1.ExecutionQuery.properties:type_name -> cnspec.policy.v1.ExecutionQuery.PropertiesEntry
	94,  // 58: cnspec.policy.v1.ExecutionQuery.code:type_name -> cnquery.llx.CodeBundle
	67,  // 59: cnspec.policy.v1.CollectorJob.reporting_jobs:type_name -> cnspec.policy.v1.CollectorJob.ReportingJobsEntry
	68,  // 60: cnspec.policy.v1.CollectorJob.reporting_queries:type_name -> cnspec.policy.v1.CollectorJob.ReportingQueriesEntry
	69,  // 61: cnspec.policy.v1.CollectorJob.datapoints:type_name -> cnspec.policy.v1.CollectorJob.DatapointsEntry
	89,  // 62: cnspec.policy.v1.ReportingJob.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	70,  // 63: cnspec.policy.v1.ReportingJob.datapoints:type_name -> cnspec.policy.v1.ReportingJob.DatapointsEntry
	71,  // 64: cnspec.policy.v1.ReportingJob.child_jobs:type_name -> cnspec.policy.v1.ReportingJob.ChildJobsEntry
	6,   // 65: cnspec.policy.v1.ReportingJob.type:type_name -> cnspec.policy.v1.ReportingJob.Type
	40,  // 66: cnspec.policy.v1.Report.score:type_name -> cnspec.policy.v1.Score
	72,  // 67: cnspec.policy.v1.Report.scores:type_name -> cnspec.policy.v1.Report.ScoresEntry
	73,  // 68: cnspec.policy.v1.Report.data:type_name -> cnspec.policy.v1.Report.DataEntry
	41,  // 69: cnspec.policy.v1.Report.stats:type_name -> cnspec.policy.v1.Stats
	41,  // 70: cnspec.policy.v1.Report.ignored_stats:type_name -> cnspec.policy.v1.Stats
	38,  // 71: cnspec.policy.v1.Report.cvss_score:type_name -> cnspec.policy.v1.Cvss
	74,  // 72: cnspec.policy.v1.Report.cvss_scores:type_name -> cnspec.policy.v1.Report.CvssScoresEntry
	39,  // 73: cnspec.policy.v1.Report.cvss_stats:type_name -> cnspec.policy.v1.CvssStats
	33,  // 74: cnspec.policy.v1.Reports.reports:type_name -> cnspec.policy.v1.Report
	75,  // 75: cnspec.policy.v1.ReportCollection.assets:type_name -> cnspec.policy.v1.ReportCollection.AssetsEntry
	13,  // 76: cnspec.policy.v1.ReportCollection.bundle:type_name -> cnspec.policy.v1.Bundle
	76,  // 77: cnspec.policy.v1.ReportCollection.reports:type_name -> cnspec.policy.v1.ReportCollection.ReportsEntry
	77,  // 78: cnspec.policy.v1.ReportCollection.errors:type_name -> cnspec.policy.v1.ReportCollection.ErrorsEntry
	78,  // 79: cnspec.policy.v1.ReportCollection.resolved_policies:type_name -> cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry
	37,  // 80: cnspec.policy.v1.FrameworkReport.score:type_name -> cnspec.policy.v1.ControlScore
	37,  // 81: cnspec.policy.v1.FrameworkReport.controls:type_name -> cnspec.policy.v1.ControlScore
	37,  // 82: cnspec.policy.v1.ControlScore.assets:type_name -> cnspec.policy.v1.ControlScore
	42,  // 83: cnspec.policy.v1.ControlScore.scores:type_name -> cnspec.policy.v1.ScoreDistribution
	...
	42,  // 86: cnspec.policy.v1.Stats.errors:type_name -> cnspec.policy.v1.ScoreDistribution
	84,  // 87: cnspec.policy.v1.Mqueries.items:type_name -> cnquery.explorer.Mquery
	87,  // 88: cnspec.policy.v1.PolicyAssignment.action:type_name -> cnquery.explorer.Action
	79,  // 89: cnspec.policy.v1.PolicyMutationDelta.policy_deltas:type_name -> cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry
	87,  // 90: cnspec.policy.v1.PolicyMutationDelta.action:type_name -> cnquery.explorer.Action
	7,   // 91: cnspec.policy.v1.PolicyDelta.action:type_name -> cnspec.policy.v1.PolicyDelta.PolicyAssignmentActionType
	84,  // 92: cnspec.policy.v1.ResolveReq.asset_filters:type_name -> cnquery.explorer.Mquery
	84,  // 93: cnspec.policy.v1.UpdateAssetJobsReq.asset_filters:type_name -> cnquery.explorer.Mquery
	40,  // 94: cnspec.policy.v1.StoreResultsReq.scores:type_name -> cnspec.policy.v1.Score
	80,  // 95: cnspec.policy.v1.StoreResultsReq.data:type_name -> cnspec.policy.v1.StoreResultsReq.DataEntry
	38,  // 96: cnspec.policy.v1.StoreResultsReq.cvssScores:type_name -> cnspec.policy.v1.Cvss
	95,  // 97: cnspec.policy.v1.SynchronizeAssetsReq.list:type_name -> cnquery.providers.v1.Asset
	81,  // 98: cnspec.policy.v1.SynchronizeAssetsResp.details:type_name -> cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry
	60,  // 99: cnspec.policy.v1.PurgeAssetsRequest.date_filter:type_name -> cnspec.policy.v1.DateFilter
	82,  // 100: cnspec.policy.v1.PurgeAssetsRequest.labels:type_name -> cnspec.policy.v1.PurgeAssetsRequest.LabelsEntry
	4,   // 101: cnspec.policy.v1.DateFilter.comparison:type_name -> cnspec.policy.v1.Comparison
	5,   // 102: cnspec.policy.v1.DateFilter.field:type_name -> cnspec.policy.v1.DateFilterField
	83,  // 103: cnspec.policy.v1.PurgeAssetsConfirmation.errors:type_name -> cnspec.policy.v1.PurgeAssetsConfirmation.ErrorsEntry
	28,  // 104: cnspec.policy.v1.ExecutionJob.QueriesEntry.value:type_name -> cnspec.policy.v1.ExecutionQuery
	32,  // 105: cnspec.policy.v1.CollectorJob.ReportingJobsEntry.value:type_name -> cnspec.policy.v1.ReportingJob
	30,  // 106: cnspec.policy.v1.CollectorJob.ReportingQueriesEntry.value:type_name -> cnspec.policy.v1.StringArray
	31,  // 107: cnspec.policy.v1.CollectorJob.DatapointsEntry.value:type_name -> cnspec.policy.v1.DataQueryInfo
	88,  // 108: cnspec.policy.v1.ReportingJob.ChildJobsEntry.value:type_name -> cnquery.explorer.Impact
	40,  // 109: cnspec.policy.v1.Report.ScoresEntry.value:type_name -> cnspec.policy.v1.Score
	96,  // 110: cnspec.policy.v1.Report.DataEntry.value:type_name -> cnquery.llx.Result
	38,  // 111: cnspec.policy.v1.Report.CvssScoresEntry.value:type_name -> cnspec.policy.v1.Cvss
	95,  // 112: cnspec.policy.v1.ReportCollection.AssetsEntry.value:type_name -> cnquery.providers.v1.Asset
	33,  // 113: cnspec.policy.v1.ReportCollection.ReportsEntry.value:type_name -> cnspec.policy.v1.Report
	26,  // 114: cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry.value:type_name -> cnspec.policy.v1.ResolvedPolicy
	51,  // 115: cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry.value:type_name -> cnspec.policy.v1.PolicyDelta
	96,  // 116: cnspec.policy.v1.StoreResultsReq.DataEntry.value:type_name -> cnquery.llx.Result
	57,  // 117: cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry.value:type_name -> cnspec.policy.v1.SynchronizeAssetsRespAssetDetail
	13,  // 118: cnspec.policy.v1.PolicyHub.SetBundle:input_type -> cnspec.policy.v1.Bundle
	13,  // 119: cnspec.policy.v1.PolicyHub.ValidateBundle:input_type -> cnspec.policy.v1.Bundle
	44,  // 120: cnspec.policy.v1.PolicyHub.GetBundle:input_type -> cnspec.policy.v1.Mrn
	44,  // 121: cnspec.policy.v1.PolicyHub.GetPolicy:input_type -> cnspec.policy.v1.Mrn
	44,  // 122: cnspec.policy.v1.PolicyHub.DeletePolicy:input_type -> cnspec.policy.v1.Mrn
	44,  // 123: cnspec.policy.v1.PolicyHub.GetPolicyFilters:input_type -> cnspec.policy.v1.Mrn
	46,  // 124: cnspec.policy.v1.PolicyHub.List:input_type -> cnspec.policy.v1.ListReq
	47,  // 125: cnspec.policy.v1.PolicyHub.DefaultPolicies:input_type -> cnspec.policy.v1.DefaultPoliciesReq
	44,  // 126: cnspec.policy.v1.PolicyHub.GetFramework:input_type -> cnspec.policy.v1.Mrn
	44,  // 127: cnspec.policy.v1.PolicyHub.DeleteFramework:input_type -> cnspec.policy.v1.Mrn
	46,  // 128: cnspec.policy.v1.PolicyHub.ListFrameworks:input_type -> cnspec.policy.v1.ListReq
	49,  // 129: cnspec.policy.v1.PolicyResolver.Assign:input_type -> cnspec.policy.v1.PolicyAssignment
	49,  // 130: cnspec.policy.v1.PolicyResolver.Unassign:input_type -> cnspec.policy.v1.PolicyAssignment
	97,  // 131: cnspec.policy.v1.PolicyResolver.SetProps:input_type -> cnquery.explorer.PropsReq
	52,  // 132: cnspec.policy.v1.PolicyResolver.Resolve:input_type -> cnspec.policy.v1.ResolveReq
	53,  // 133: cnspec.policy.v1.PolicyResolver.UpdateAssetJobs:input_type -> cnspec.policy.v1.UpdateAssetJobsReq
	53,  // 134: cnspec.policy.v1.PolicyResolver.ResolveAndUpdateJobs:input_type -> cnspec.policy.v1.UpdateAssetJobsReq
	44,  // 135: cnspec.policy.v1.PolicyResolver.GetResolvedPolicy:input_type -> cnspec.policy.v1.Mrn
	54,  // 136: cnspec.policy.v1.PolicyResolver.StoreResults:input_type -> cnspec.policy.v1.StoreResultsReq
	55,  // 137: cnspec.policy.v1.PolicyResolver.GetReport:input_type -> cnspec.policy.v1.EntityScoreReq
	55,  // 138: cnspec.policy.v1.PolicyResolver.GetFrameworkReport:input_type -> cnspec.policy.v1.EntityScoreReq
	55,  // 139: cnspec.policy.v1.PolicyResolver.GetScore:input_type -> cnspec.policy.v1.EntityScoreReq
	56,  // 140: cnspec.policy.v1.PolicyResolver.SynchronizeAssets:input_type -> cnspec.policy.v1.SynchronizeAssetsReq
	59,  // 141: cnspec.policy.v1.PolicyResolver.PurgeAssets:input_type -> cnspec.policy.v1.PurgeAssetsRequest
	43,  // 142: cnspec.policy.v1.PolicyHub.SetBundle:output_type -> cnspec.policy.v1.Empty
	43,  // 143: cnspec.policy.v1.PolicyHub.ValidateBundle:output_type -> cnspec.policy.v1.Empty
	13,  // 144: cnspec.policy.v1.PolicyHub.GetBundle:output_type -> cnspec.policy.v1.Bundle
	10,  // 145: cnspec.policy.v1.PolicyHub.GetPolicy:output_type -> cnspec.policy.v1.Policy
	43,  // 146: cnspec.policy.v1.PolicyHub.DeletePolicy:output_type -> cnspec.policy.v1.Empty
	45,  // 147: cnspec.policy.v1.PolicyHub.GetPolicyFilters:output_type -> cnspec.policy.v1.Mqueries
	11,  // 148: cnspec.policy.v1.PolicyHub.List:output_type -> cnspec.policy.v1.Policies
	48,  // 149: cnspec.policy.v1.PolicyHub.DefaultPolicies:output_type -> cnspec.policy.v1.URLs
	16,  // 150: cnspec.policy.v1.PolicyHub.GetFramework:output_type -> cnspec.policy.v1.Framework
	43,  // 151: cnspec.policy.v1.PolicyHub.DeleteFramework:output_type -> cnspec.policy.v1.Empty
	17,  // 152: cnspec.policy.v1.PolicyHub.ListFrameworks:output_type -> cnspec.policy.v1.Frameworks
	43,  // 153: cnspec.policy.v1.PolicyResolver.Assign:output_type -> cnspec.policy.v1.Empty
	43,  // 154: cnspec.policy.v1.PolicyResolver.Unassign:output_type -> cnspec.policy.v1.Empty
	98,  // 155: cnspec.policy.v1.PolicyResolver.SetProps:output_type -> cnquery.explorer.Empty
	26,  // 156: cnspec.policy.v1.PolicyResolver.Resolve:output_type -> cnspec.policy.v1.ResolvedPolicy
	43,  // 157: cnspec.policy.v1.PolicyResolver.UpdateAssetJobs:output_type -> cnspec.policy.v1.Empty
	26,  // 158: cnspec.policy.v1.PolicyResolver.ResolveAndUpdateJobs:output_type -> cnspec.policy.v1.ResolvedPolicy
	26,  // 159: cnspec.policy.v1.PolicyResolver.GetResolvedPolicy:output_type -> cnspec.policy.v1.ResolvedPolicy
	43,  // 160: cnspec.policy.v1.PolicyResolver.StoreResults:output_type -> cnspec.policy.v1.Empty
	33,  // 161: cnspec.policy.v1.PolicyResolver.GetReport:output_type -> cnspec.policy.v1.Report
	36,  // 162: cnspec.policy.v1.PolicyResolver.GetFrameworkReport:output_type -> cnspec.policy.v1.FrameworkReport
	33,  // 163: cnspec.policy.v1.PolicyResolver.GetScore:output_type -> cnspec.policy.v1.Report
	58,  // 164: cnspec.policy.v1.PolicyResolver.SynchronizeAssets:output_type -> cnspec.policy.v1.SynchronizeAssetsResp
	61,  // 165: cnspec.policy.v1.PolicyResolver.PurgeAssets:output_type -> cnspec.policy.v1.PurgeAssetsConfirmation
