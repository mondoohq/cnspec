...
func (Migration_Action) EnumDescriptor() ([]byte, []int) {
	return file_cnspec_policy_proto_rawDescGZIP(), []int{12, 0}
}
...
func (PolicyDelta_PolicyAssignmentActionType) EnumDescriptor() ([]byte, []int) {
	return file_cnspec_policy_proto_rawDescGZIP(), []int{65, 0}
}
...
func (Source_Vendor) EnumDescriptor() ([]byte, []int) {
	return file_cnspec_policy_proto_rawDescGZIP(), []int{81, 0}
}
...
type MigrationPolicyRef struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SourceUid     string                 `protobuf:"bytes,1,opt,name=source_uid,json=sourceUid,proto3" json:"source_uid,omitempty"`             // target will be used if not set
	TargetUid     string                 `protobuf:"bytes,2,opt,name=target_uid,json=targetUid,proto3" json:"target_uid,omitempty"`             // must match the policy supplied with bundle
	SourceVersion string                 `protobuf:"bytes,3,opt,name=source_version,json=sourceVersion,proto3" json:"source_version,omitempty"` // target will be used if not set
	TargetVersion string                 `protobuf:"bytes,4,opt,name=target_version,json=targetVersion,proto3" json:"target_version,omitempty"` // must match the policy supplied with bundle
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MigrationPolicyRef) GetSourceUid() string {
	if x != nil {
		return x.SourceUid
	}
	return ""
...
func (x *MigrationPolicyRef) GetTargetUid() string {
	if x != nil {
		return x.TargetUid
	}
	return ""
...
func (x *MigrationPolicyRef) GetSourceVersion() string {
	if x != nil {
...
func (x *MigrationPolicyRef) GetTargetVersion() string {
	if x != nil {
...
type MigrationGroup struct {
	...
	Policy *MigrationPolicyRef `protobuf:"bytes,3,opt,name=policy,proto3" json:"policy,omitempty"`
...
func (x *MigrationGroup) GetPolicy() *MigrationPolicyRef {
	if x != nil {
		return x.Policy
	}
	return nil
...
const file_cnspec_policy_proto_rawDesc = "" +
	...
	"\x10migration_groups\x18\v \x03(\v2 .cnspec.policy.v1.MigrationGroupR\x0fmigrationGroups\"\xa0\x01\n" +
	"\x12MigrationPolicyRef\x12\x1d\n" +
	"\n" +
	...
	"\x0etarget_version\x18\x04 \x01(\tR\rtargetVersion\"\x9c\x02\n" +
	"\x0eMigrationGroup\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x12;\n" +
	"\n" +
	"migrations\x18\x02 \x03(\v2\x1b.cnspec.policy.v1.MigrationR\n" +
	"migrations\x12<\n" +
	"\x06policy\x18\x03 \x01(\v2$.cnspec.policy.v1.MigrationPolicyRefR\x06policy\x128\n" +
...
var file_cnspec_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 112)
var file_cnspec_policy_proto_goTypes = []any{
	...
	(*MigrationMetadata)(nil),                   // 23: cnspec.policy.v1.MigrationMetadata
	(*MigrationStage)(nil),                      // 24: cnspec.policy.v1.MigrationStage
	(*Migration)(nil),                           // 25: cnspec.policy.v1.Migration
	(*MigrationSource)(nil),                     // 26: cnspec.policy.v1.MigrationSource
	(*MigrationTarget)(nil),                     // 27: cnspec.policy.v1.MigrationTarget
	(*SoftwareSelector)(nil),                    // 28: cnspec.policy.v1.SoftwareSelector
	(*ResourceSelector)(nil),                    // 29: cnspec.policy.v1.ResourceSelector
	(*RiskMagnitude)(nil),                       // 30: cnspec.policy.v1.RiskMagnitude
	(*RiskFactor)(nil),                          // 31: cnspec.policy.v1.RiskFactor
	(*RiskFactorDocs)(nil),                      // 32: cnspec.policy.v1.RiskFactorDocs
	(*PolicyGroupDocs)(nil),                     // 33: cnspec.policy.v1.PolicyGroupDocs
	(*PolicyDocs)(nil),                          // 34: cnspec.policy.v1.PolicyDocs
	(*Framework)(nil),                           // 35: cnspec.policy.v1.Framework
	(*Frameworks)(nil),                          // 36: cnspec.policy.v1.Frameworks
	(*FrameworkGroup)(nil),                      // 37: cnspec.policy.v1.FrameworkGroup
	(*FrameworkRef)(nil),                        // 38: cnspec.policy.v1.FrameworkRef
	(*Evidence)(nil),                            // 39: cnspec.policy.v1.Evidence
	(*Control)(nil),                             // 40: cnspec.policy.v1.Control
	(*FrameworkMap)(nil),                        // 41: cnspec.policy.v1.FrameworkMap
	(*ControlMap)(nil),                          // 42: cnspec.policy.v1.ControlMap
	(*ControlDocs)(nil),                         // 43: cnspec.policy.v1.ControlDocs
	(*ControlRef)(nil),                          // 44: cnspec.policy.v1.ControlRef
	(*Asset)(nil),                               // 45: cnspec.policy.v1.Asset
	(*ResolvedPolicy)(nil),                      // 46: cnspec.policy.v1.ResolvedPolicy
	(*ExecutionJob)(nil),                        // 47: cnspec.policy.v1.ExecutionJob
	(*ExecutionQuery)(nil),                      // 48: cnspec.policy.v1.ExecutionQuery
	(*CollectorJob)(nil),                        // 49: cnspec.policy.v1.CollectorJob
	(*StringArray)(nil),                         // 50: cnspec.policy.v1.StringArray
	(*DataQueryInfo)(nil),                       // 51: cnspec.policy.v1.DataQueryInfo
	(*ReportingJob)(nil),                        // 52: cnspec.policy.v1.ReportingJob
	(*Report)(nil),                              // 53: cnspec.policy.v1.Report
	(*Reports)(nil),                             // 54: cnspec.policy.v1.Reports
	(*ReportCollection)(nil),                    // 55: cnspec.policy.v1.ReportCollection
	(*FrameworkReport)(nil),                     // 56: cnspec.policy.v1.FrameworkReport
	(*ControlScore)(nil),                        // 57: cnspec.policy.v1.ControlScore
	(*Cvss)(nil),                                // 58: cnspec.policy.v1.Cvss
	(*CvssStats)(nil),                           // 59: cnspec.policy.v1.CvssStats
	(*Score)(nil),                               // 60: cnspec.policy.v1.Score
	(*ScoreDelta)(nil),                          // 61: cnspec.policy.v1.ScoreDelta
	(*ScoredRiskFactor)(nil),                    // 62: cnspec.policy.v1.ScoredRiskFactor
	(*ScoredRiskFactors)(nil),                   // 63: cnspec.policy.v1.ScoredRiskFactors
	(*RiskFactorStats)(nil),                     // 64: cnspec.policy.v1.RiskFactorStats
	(*RiskFactorsStats)(nil),                    // 65: cnspec.policy.v1.RiskFactorsStats
	(*Stats)(nil),                               // 66: cnspec.policy.v1.Stats
	(*ScoreDistribution)(nil),                   // 67: cnspec.policy.v1.ScoreDistribution
	(*ScoreStats)(nil),                          // 68: cnspec.policy.v1.ScoreStats
	(*AssetFindingsStats)(nil),                  // 69: cnspec.policy.v1.AssetFindingsStats
	(*Empty)(nil),                               // 70: cnspec.policy.v1.Empty
	(*Mrn)(nil),                                 // 71: cnspec.policy.v1.Mrn
	(*Mqueries)(nil),                            // 72: cnspec.policy.v1.Mqueries
	(*ListReq)(nil),                             // 73: cnspec.policy.v1.ListReq
	(*DefaultPoliciesReq)(nil),                  // 74: cnspec.policy.v1.DefaultPoliciesReq
	(*URLs)(nil),                                // 75: cnspec.policy.v1.URLs
	(*PolicyAssignment)(nil),                    // 76: cnspec.policy.v1.PolicyAssignment
	(*PolicyMutationDelta)(nil),                 // 77: cnspec.policy.v1.PolicyMutationDelta
	(*PolicyDelta)(nil),                         // 78: cnspec.policy.v1.PolicyDelta
	(*ResolveReq)(nil),                          // 79: cnspec.policy.v1.ResolveReq
	(*UpdateAssetJobsReq)(nil),                  // 80: cnspec.policy.v1.UpdateAssetJobsReq
	(*StoreResultsReq)(nil),                     // 81: cnspec.policy.v1.StoreResultsReq
	(*GetUploadURLReq)(nil),                     // 82: cnspec.policy.v1.GetUploadURLReq
	(*GetUploadURLResp)(nil),                    // 83: cnspec.policy.v1.GetUploadURLResp
	(*UploadURL)(nil),                           // 84: cnspec.policy.v1.UploadURL
	(*ReportUploadCompletedReq)(nil),            // 85: cnspec.policy.v1.ReportUploadCompletedReq
	(*EntityScoreReq)(nil),                      // 86: cnspec.policy.v1.EntityScoreReq
	(*SynchronizeAssetsReq)(nil),                // 87: cnspec.policy.v1.SynchronizeAssetsReq
	(*SynchronizeAssetsRespAssetDetail)(nil),    // 88: cnspec.policy.v1.SynchronizeAssetsRespAssetDetail
	(*SynchronizeAssetsResp)(nil),               // 89: cnspec.policy.v1.SynchronizeAssetsResp
	(*PurgeAssetsRequest)(nil),                  // 90: cnspec.policy.v1.PurgeAssetsRequest
	(*DateFilter)(nil),                          // 91: cnspec.policy.v1.DateFilter
	(*PurgeAssetsConfirmation)(nil),             // 92: cnspec.policy.v1.PurgeAssetsConfirmation
	(*Sources)(nil),                             // 93: cnspec.policy.v1.Sources
	(*Source)(nil),                              // 94: cnspec.policy.v1.Source
	nil,                                         // 95: cnspec.policy.v1.Policy.TagsEntry
	nil,                                         // 96: cnspec.policy.v1.MigrationMetadata.LabelsEntry
	nil,                                         // 97: cnspec.policy.v1.RiskFactor.TagsEntry
	nil,                                         // 98: cnspec.policy.v1.Framework.TagsEntry
	nil,                                         // 99: cnspec.policy.v1.Control.TagsEntry
	nil,                                         // 100: cnspec.policy.v1.ExecutionJob.QueriesEntry
	nil,                                         // 101: cnspec.policy.v1.ExecutionQuery.PropertiesEntry
	nil,                                         // 102: cnspec.policy.v1.CollectorJob.ReportingJobsEntry
	nil,                                         // 103: cnspec.policy.v1.CollectorJob.ReportingQueriesEntry
	nil,                                         // 104: cnspec.policy.v1.CollectorJob.DatapointsEntry
	nil,                                         // 105: cnspec.policy.v1.CollectorJob.RiskMrnsEntry
	nil,                                         // 106: cnspec.policy.v1.CollectorJob.RiskFactorsEntry
	nil,                                         // 107: cnspec.policy.v1.ReportingJob.DatapointsEntry
	nil,                                         // 108: cnspec.policy.v1.ReportingJob.ChildJobsEntry
	nil,                                         // 109: cnspec.policy.v1.Report.ScoresEntry
	nil,                                         // 110: cnspec.policy.v1.Report.DataEntry
	nil,                                         // 111: cnspec.policy.v1.Report.CvssScoresEntry
	nil,                                         // 112: cnspec.policy.v1.ReportCollection.AssetsEntry
	nil,                                         // 113: cnspec.policy.v1.ReportCollection.ReportsEntry
	nil,                                         // 114: cnspec.policy.v1.ReportCollection.ErrorsEntry
	nil,                                         // 115: cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry
	nil,                                         // 116: cnspec.policy.v1.ReportCollection.VulnReportsEntry
	nil,                                         // 117: cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry
	nil,                                         // 118: cnspec.policy.v1.StoreResultsReq.DataEntry
	nil,                                         // 119: cnspec.policy.v1.StoreResultsReq.ResourcesEntry
	nil,                                         // 120: cnspec.policy.v1.UploadURL.HeadersEntry
	nil,                                         // 121: cnspec.policy.v1.SynchronizeAssetsRespAssetDetail.AnnotationsEntry
	nil,                                         // 122: cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry
	nil,                                         // 123: cnspec.policy.v1.PurgeAssetsRequest.LabelsEntry
	nil,                                         // 124: cnspec.policy.v1.PurgeAssetsConfirmation.ErrorsEntry
	(*explorer.Mquery)(nil),                     // 125: cnquery.explorer.Mquery
	(*explorer.Filters)(nil),                    // 126: cnquery.explorer.Filters
	(*explorer.Author)(nil),                     // 127: cnquery.explorer.Author
	(*explorer.HumanTime)(nil),                  // 128: cnquery.explorer.HumanTime
	(explorer.Action)(0),                        // 129: cnquery.explorer.Action
	(*explorer.Impact)(nil),                     // 130: cnquery.explorer.Impact
	(explorer.ScoringSystem)(0),                 // 131: cnquery.explorer.ScoringSystem
	(*explorer.Property)(nil),                   // 132: cnquery.explorer.Property
	(*explorer.QueryPack)(nil),                  // 133: cnquery.explorer.QueryPack
	(*timestamppb.Timestamp)(nil),               // 134: google.protobuf.Timestamp
	(*explorer.ObjectRef)(nil),                  // 135: cnquery.explorer.ObjectRef
	(*explorer.MqueryRef)(nil),                  // 136: cnquery.explorer.MqueryRef
	(*inventory.Platform)(nil),                  // 137: cnquery.providers.v1.Platform
	(*llx.CodeBundle)(nil),                      // 138: cnquery.llx.CodeBundle
	(*inventory.Asset)(nil),                     // 139: cnquery.providers.v1.Asset
	(*llx.Result)(nil),                          // 140: cnquery.llx.Result
	(*mvd.VulnReport)(nil),                      // 141: mondoo.mvd.v1.VulnReport
	(*llx.ResourceRecording)(nil),               // 142: cnquery.llx.ResourceRecording
	(*explorer.PropsReq)(nil),                   // 143: cnquery.explorer.PropsReq
	(*resources.EntityResourcesReq)(nil),        // 144: cnquery.explorer.resources.EntityResourcesReq
	(*explorer.Empty)(nil),                      // 145: cnquery.explorer.Empty
	(*resources.EntityResourcesRes)(nil),        // 146: cnquery.explorer.resources.EntityResourcesRes
}
var file_cnspec_policy_proto_depIdxs = []int32{
	...
	125, // 1: cnspec.policy.v1.PolicyGroup.checks:type_name -> cnquery.explorer.Mquery
	125, // 2: cnspec.policy.v1.PolicyGroup.queries:type_name -> cnquery.explorer.Mquery
	0,   // 3: cnspec.policy.v1.PolicyGroup.type:type_name -> cnspec.policy.v1.GroupType
	126, // 4: cnspec.policy.v1.PolicyGroup.filters:type_name -> cnquery.explorer.Filters
	14,  // 5: cnspec.policy.v1.PolicyGroup.valid:type_name -> cnspec.policy.v1.Validity
	33,  // 6: cnspec.policy.v1.PolicyGroup.docs:type_name -> cnspec.policy.v1.PolicyGroupDocs
	127, // 7: cnspec.policy.v1.PolicyGroup.authors:type_name -> cnquery.explorer.Author
	127, // 8: cnspec.policy.v1.PolicyGroup.reviewers:type_name -> cnquery.explorer.Author
	3,   // 9: cnspec.policy.v1.PolicyGroup.review_status:type_name -> cnspec.policy.v1.ReviewStatus
	128, // 10: cnspec.policy.v1.Validity.from:type_name -> cnquery.explorer.HumanTime
	128, // 11: cnspec.policy.v1.Validity.until:type_name -> cnquery.explorer.HumanTime
	129, // 12: cnspec.policy.v1.PolicyRef.action:type_name -> cnquery.explorer.Action
	130, // 13: cnspec.policy.v1.PolicyRef.impact:type_name -> cnquery.explorer.Impact
	131, // 14: cnspec.policy.v1.PolicyRef.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	13,  // 15: cnspec.policy.v1.Policy.groups:type_name -> cnspec.policy.v1.PolicyGroup
	34,  // 16: cnspec.policy.v1.Policy.docs:type_name -> cnspec.policy.v1.PolicyDocs
	131, // 17: cnspec.policy.v1.Policy.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	127, // 18: cnspec.policy.v1.Policy.authors:type_name -> cnquery.explorer.Author
	95,  // 19: cnspec.policy.v1.Policy.tags:type_name -> cnspec.policy.v1.Policy.TagsEntry
	132, // 20: cnspec.policy.v1.Policy.props:type_name -> cnquery.explorer.Property
	31,  // 21: cnspec.policy.v1.Policy.risk_factors:type_name -> cnspec.policy.v1.RiskFactor
	18,  // 22: cnspec.policy.v1.Policy.require:type_name -> cnspec.policy.v1.Requirement
	126, // 23: cnspec.policy.v1.Policy.computed_filters:type_name -> cnquery.explorer.Filters
	...
	133, // 27: cnspec.policy.v1.Bundle.packs:type_name -> cnquery.explorer.QueryPack
	132, // 28: cnspec.policy.v1.Bundle.props:type_name -> cnquery.explorer.Property
	125, // 29: cnspec.policy.v1.Bundle.queries:type_name -> cnquery.explorer.Mquery
	35,  // 30: cnspec.policy.v1.Bundle.frameworks:type_name -> cnspec.policy.v1.Framework
	41,  // 31: cnspec.policy.v1.Bundle.framework_maps:type_name -> cnspec.policy.v1.FrameworkMap
	34,  // 32: cnspec.policy.v1.Bundle.docs:type_name -> cnspec.policy.v1.PolicyDocs
	22,  // 33: cnspec.policy.v1.Bundle.migration_groups:type_name -> cnspec.policy.v1.MigrationGroup
	25,  // 34: cnspec.policy.v1.MigrationGroup.migrations:type_name -> cnspec.policy.v1.Migration
	21,  // 35: cnspec.policy.v1.MigrationGroup.policy:type_name -> cnspec.policy.v1.MigrationPolicyRef
	24,  // 36: cnspec.policy.v1.MigrationGroup.stages:type_name -> cnspec.policy.v1.MigrationStage
	23,  // 37: cnspec.policy.v1.MigrationGroup.metadata:type_name -> cnspec.policy.v1.MigrationMetadata
	134, // 38: cnspec.policy.v1.MigrationMetadata.created_at:type_name -> google.protobuf.Timestamp
	96,  // 39: cnspec.policy.v1.MigrationMetadata.labels:type_name -> cnspec.policy.v1.MigrationMetadata.LabelsEntry
	25,  // 40: cnspec.policy.v1.MigrationStage.migrations:type_name -> cnspec.policy.v1.Migration
	25,  // 41: cnspec.policy.v1.MigrationStage.policy_migrations:type_name -> cnspec.policy.v1.Migration
	26,  // 42: cnspec.policy.v1.Migration.source:type_name -> cnspec.policy.v1.MigrationSource
	27,  // 43: cnspec.policy.v1.Migration.target:type_name -> cnspec.policy.v1.MigrationTarget
	9,   // 44: cnspec.policy.v1.Migration.action:type_name -> cnspec.policy.v1.Migration.Action
	32,  // 45: cnspec.policy.v1.RiskFactor.docs:type_name -> cnspec.policy.v1.RiskFactorDocs
	126, // 46: cnspec.policy.v1.RiskFactor.filters:type_name -> cnquery.explorer.Filters
	125, // 47: cnspec.policy.v1.RiskFactor.checks:type_name -> cnquery.explorer.Mquery
	2,   // 48: cnspec.policy.v1.RiskFactor.scope:type_name -> cnspec.policy.v1.ScopeType
	30,  // 49: cnspec.policy.v1.RiskFactor.magnitude:type_name -> cnspec.policy.v1.RiskMagnitude
	28,  // 50: cnspec.policy.v1.RiskFactor.software:type_name -> cnspec.policy.v1.SoftwareSelector
	29,  // 51: cnspec.policy.v1.RiskFactor.resources:type_name -> cnspec.policy.v1.ResourceSelector
	129, // 52: cnspec.policy.v1.RiskFactor.action:type_name -> cnquery.explorer.Action
	97,  // 53: cnspec.policy.v1.RiskFactor.tags:type_name -> cnspec.policy.v1.RiskFactor.TagsEntry
	37,  // 54: cnspec.policy.v1.Framework.groups:type_name -> cnspec.policy.v1.FrameworkGroup
	34,  // 55: cnspec.policy.v1.Framework.docs:type_name -> cnspec.policy.v1.PolicyDocs
	127, // 56: cnspec.policy.v1.Framework.authors:type_name -> cnquery.explorer.Author
	98,  // 57: cnspec.policy.v1.Framework.tags:type_name -> cnspec.policy.v1.Framework.TagsEntry
	38,  // 58: cnspec.policy.v1.Framework.dependencies:type_name -> cnspec.policy.v1.FrameworkRef
	41,  // 59: cnspec.policy.v1.Framework.framework_maps:type_name -> cnspec.policy.v1.FrameworkMap
	35,  // 60: cnspec.policy.v1.Frameworks.items:type_name -> cnspec.policy.v1.Framework
	40,  // 61: cnspec.policy.v1.FrameworkGroup.controls:type_name -> cnspec.policy.v1.Control
	0,   // 62: cnspec.policy.v1.FrameworkGroup.type:type_name -> cnspec.policy.v1.GroupType
	33,  // 63: cnspec.policy.v1.FrameworkGroup.docs:type_name -> cnspec.policy.v1.PolicyGroupDocs
	127, // 64: cnspec.policy.v1.FrameworkGroup.authors:type_name -> cnquery.explorer.Author
	127, // 65: cnspec.policy.v1.FrameworkGroup.reviewers:type_name -> cnquery.explorer.Author
	3,   // 66: cnspec.policy.v1.FrameworkGroup.review_status:type_name -> cnspec.policy.v1.ReviewStatus
	129, // 67: cnspec.policy.v1.FrameworkRef.action:type_name -> cnquery.explorer.Action
	125, // 68: cnspec.policy.v1.Evidence.checks:type_name -> cnquery.explorer.Mquery
	125, // 69: cnspec.policy.v1.Evidence.queries:type_name -> cnquery.explorer.Mquery
	44,  // 70: cnspec.policy.v1.Evidence.controls:type_name -> cnspec.policy.v1.ControlRef
	43,  // 71: cnspec.policy.v1.Control.docs:type_name -> cnspec.policy.v1.ControlDocs
	99,  // 72: cnspec.policy.v1.Control.tags:type_name -> cnspec.policy.v1.Control.TagsEntry
	129, // 73: cnspec.policy.v1.Control.action:type_name -> cnquery.explorer.Action
	39,  // 74: cnspec.policy.v1.Control.evidence:type_name -> cnspec.policy.v1.Evidence
	135, // 75: cnspec.policy.v1.FrameworkMap.framework_dependencies:type_name -> cnquery.explorer.ObjectRef
	135, // 76: cnspec.policy.v1.FrameworkMap.policy_dependencies:type_name -> cnquery.explorer.ObjectRef
	135, // 77: cnspec.policy.v1.FrameworkMap.query_pack_dependencies:type_name -> cnquery.explorer.ObjectRef
	42,  // 78: cnspec.policy.v1.FrameworkMap.controls:type_name -> cnspec.policy.v1.ControlMap
	135, // 79: cnspec.policy.v1.FrameworkMap.framework_owner:type_name -> cnquery.explorer.ObjectRef
	44,  // 80: cnspec.policy.v1.ControlMap.checks:type_name -> cnspec.policy.v1.ControlRef
	44,  // 81: cnspec.policy.v1.ControlMap.policies:type_name -> cnspec.policy.v1.ControlRef
	44,  // 82: cnspec.policy.v1.ControlMap.controls:type_name -> cnspec.policy.v1.ControlRef
	44,  // 83: cnspec.policy.v1.ControlMap.queries:type_name -> cnspec.policy.v1.ControlRef
	136, // 84: cnspec.policy.v1.ControlDocs.refs:type_name -> cnquery.explorer.MqueryRef
	129, // 85: cnspec.policy.v1.ControlRef.action:type_name -> cnquery.explorer.Action
	137, // 86: cnspec.policy.v1.Asset.platform:type_name -> cnquery.providers.v1.Platform
	47,  // 87: cnspec.policy.v1.ResolvedPolicy.execution_job:type_name -> cnspec.policy.v1.ExecutionJob
	49,  // 88: cnspec.policy.v1.ResolvedPolicy.collector_job:type_name -> cnspec.policy.v1.CollectorJob
	125, // 89: cnspec.policy.v1.ResolvedPolicy.filters:type_name -> cnquery.explorer.Mquery
	4,   // 90: cnspec.policy.v1.ResolvedPolicy.features:type_name -> cnspec.policy.v1.ServerFeature
	100, // 91: cnspec.policy.v1.ExecutionJob.queries:type_name -> cnspec.policy.v1.ExecutionJob.QueriesEntry
	101, // 92: cnspec.policy.v1.ExecutionQuery.properties:type_name -> cnspec.policy.v1.ExecutionQuery.PropertiesEntry
	138, // 93: cnspec.policy.v1.ExecutionQuery.code:type_name -> cnquery.llx.CodeBundle
	102, // 94: cnspec.policy.v1.CollectorJob.reporting_jobs:type_name -> cnspec.policy.v1.CollectorJob.ReportingJobsEntry
	103, // 95: cnspec.policy.v1.CollectorJob.reporting_queries:type_name -> cnspec.policy.v1.CollectorJob.ReportingQueriesEntry
	104, // 96: cnspec.policy.v1.CollectorJob.datapoints:type_name -> cnspec.policy.v1.CollectorJob.DatapointsEntry
	105, // 97: cnspec.policy.v1.CollectorJob.risk_mrns:type_name -> cnspec.policy.v1.CollectorJob.RiskMrnsEntry
	106, // 98: cnspec.policy.v1.CollectorJob.risk_factors:type_name -> cnspec.policy.v1.CollectorJob.RiskFactorsEntry
	131, // 99: cnspec.policy.v1.ReportingJob.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	107, // 100: cnspec.policy.v1.ReportingJob.datapoints:type_name -> cnspec.policy.v1.ReportingJob.DatapointsEntry
	108, // 101: cnspec.policy.v1.ReportingJob.child_jobs:type_name -> cnspec.policy.v1.ReportingJob.ChildJobsEntry
	10,  // 102: cnspec.policy.v1.ReportingJob.type:type_name -> cnspec.policy.v1.ReportingJob.Type
	60,  // 103: cnspec.policy.v1.Report.score:type_name -> cnspec.policy.v1.Score
	109, // 104: cnspec.policy.v1.Report.scores:type_name -> cnspec.policy.v1.Report.ScoresEntry
	110, // 105: cnspec.policy.v1.Report.data:type_name -> cnspec.policy.v1.Report.DataEntry
	66,  // 106: cnspec.policy.v1.Report.stats:type_name -> cnspec.policy.v1.Stats
	63,  // 107: cnspec.policy.v1.Report.risks:type_name -> cnspec.policy.v1.ScoredRiskFactors
	66,  // 108: cnspec.policy.v1.Report.ignored_stats:type_name -> cnspec.policy.v1.Stats
	58,  // 109: cnspec.policy.v1.Report.cvss_score:type_name -> cnspec.policy.v1.Cvss
	111, // 110: cnspec.policy.v1.Report.cvss_scores:type_name -> cnspec.policy.v1.Report.CvssScoresEntry
	59,  // 111: cnspec.policy.v1.Report.cvss_stats:type_name -> cnspec.policy.v1.CvssStats
	53,  // 112: cnspec.policy.v1.Reports.reports:type_name -> cnspec.policy.v1.Report
	112, // 113: cnspec.policy.v1.ReportCollection.assets:type_name -> cnspec.policy.v1.ReportCollection.AssetsEntry
	20,  // 114: cnspec.policy.v1.ReportCollection.bundle:type_name -> cnspec.policy.v1.Bundle
	113, // 115: cnspec.policy.v1.ReportCollection.reports:type_name -> cnspec.policy.v1.ReportCollection.ReportsEntry
	114, // 116: cnspec.policy.v1.ReportCollection.errors:type_name -> cnspec.policy.v1.ReportCollection.ErrorsEntry
	115, // 117: cnspec.policy.v1.ReportCollection.resolved_policies:type_name -> cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry
	116, // 118: cnspec.policy.v1.ReportCollection.vuln_reports:type_name -> cnspec.policy.v1.ReportCollection.VulnReportsEntry
	57,  // 119: cnspec.policy.v1.FrameworkReport.score:type_name -> cnspec.policy.v1.ControlScore
	57,  // 120: cnspec.policy.v1.FrameworkReport.controls:type_name -> cnspec.policy.v1.ControlScore
	57,  // 121: cnspec.policy.v1.ControlScore.assets:type_name -> cnspec.policy.v1.ControlScore
	67,  // 122: cnspec.policy.v1.ControlScore.scores:type_name -> cnspec.policy.v1.ScoreDistribution
	63,  // 123: cnspec.policy.v1.Score.risk_factors:type_name -> cnspec.policy.v1.ScoredRiskFactors
	94,  // 124: cnspec.policy.v1.Score.source:type_name -> cnspec.policy.v1.Source
	93,  // 125: cnspec.policy.v1.Score.sources:type_name -> cnspec.policy.v1.Sources
	62,  // 126: cnspec.policy.v1.ScoredRiskFactors.items:type_name -> cnspec.policy.v1.ScoredRiskFactor
	64,  // 127: cnspec.policy.v1.RiskFactorsStats.items:type_name -> cnspec.policy.v1.RiskFactorStats
	67,  // 128: cnspec.policy.v1.Stats.failed:type_name -> cnspec.policy.v1.ScoreDistribution
	67,  // 129: cnspec.policy.v1.Stats.passed:type_name -> cnspec.policy.v1.ScoreDistribution
	67,  // 130: cnspec.policy.v1.Stats.errors:type_name -> cnspec.policy.v1.ScoreDistribution
	68,  // 131: cnspec.policy.v1.AssetFindingsStats.score_stats:type_name -> cnspec.policy.v1.ScoreStats
	65,  // 132: cnspec.policy.v1.AssetFindingsStats.risk_factors:type_name -> cnspec.policy.v1.RiskFactorsStats
	125, // 133: cnspec.policy.v1.Mqueries.items:type_name -> cnquery.explorer.Mquery
	129, // 134: cnspec.policy.v1.PolicyAssignment.action:type_name -> cnquery.explorer.Action
	131, // 135: cnspec.policy.v1.PolicyAssignment.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	117, // 136: cnspec.policy.v1.PolicyMutationDelta.policy_deltas:type_name -> cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry
	129, // 137: cnspec.policy.v1.PolicyMutationDelta.action:type_name -> cnquery.explorer.Action
	11,  // 138: cnspec.policy.v1.PolicyDelta.action:type_name -> cnspec.policy.v1.PolicyDelta.PolicyAssignmentActionType
	131, // 139: cnspec.policy.v1.PolicyDelta.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	125, // 140: cnspec.policy.v1.ResolveReq.asset_filters:type_name -> cnquery.explorer.Mquery
	125, // 141: cnspec.policy.v1.UpdateAssetJobsReq.asset_filters:type_name -> cnquery.explorer.Mquery
	60,  // 142: cnspec.policy.v1.StoreResultsReq.scores:type_name -> cnspec.policy.v1.Score
	118, // 143: cnspec.policy.v1.StoreResultsReq.data:type_name -> cnspec.policy.v1.StoreResultsReq.DataEntry
	119, // 144: cnspec.policy.v1.StoreResultsReq.resources:type_name -> cnspec.policy.v1.StoreResultsReq.ResourcesEntry
	62,  // 145: cnspec.policy.v1.StoreResultsReq.risks:type_name -> cnspec.policy.v1.ScoredRiskFactor
	58,  // 146: cnspec.policy.v1.StoreResultsReq.cvssScores:type_name -> cnspec.policy.v1.Cvss
	5,   // 147: cnspec.policy.v1.GetUploadURLReq.kind:type_name -> cnspec.policy.v1.UploadURLKind
	84,  // 148: cnspec.policy.v1.GetUploadURLResp.upload_url:type_name -> cnspec.policy.v1.UploadURL
	120, // 149: cnspec.policy.v1.UploadURL.headers:type_name -> cnspec.policy.v1.UploadURL.HeadersEntry
	139, // 150: cnspec.policy.v1.SynchronizeAssetsReq.list:type_name -> cnquery.providers.v1.Asset
	121, // 151: cnspec.policy.v1.SynchronizeAssetsRespAssetDetail.annotations:type_name -> cnspec.policy.v1.SynchronizeAssetsRespAssetDetail.AnnotationsEntry
	122, // 152: cnspec.policy.v1.SynchronizeAssetsResp.details:type_name -> cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry
	91,  // 153: cnspec.policy.v1.PurgeAssetsRequest.date_filter:type_name -> cnspec.policy.v1.DateFilter
	123, // 154: cnspec.policy.v1.PurgeAssetsRequest.labels:type_name -> cnspec.policy.v1.PurgeAssetsRequest.LabelsEntry
	...
	124, // 157: cnspec.policy.v1.PurgeAssetsConfirmation.errors:type_name -> cnspec.policy.v1.PurgeAssetsConfirmation.ErrorsEntry
	94,  // 158: cnspec.policy.v1.Sources.items:type_name -> cnspec.policy.v1.Source
	12,  // 159: cnspec.policy.v1.Source.vendor:type_name -> cnspec.policy.v1.Source.Vendor
	48,  // 160: cnspec.policy.v1.ExecutionJob.QueriesEntry.value:type_name -> cnspec.policy.v1.ExecutionQuery
	52,  // 161: cnspec.policy.v1.CollectorJob.ReportingJobsEntry.value:type_name -> cnspec.policy.v1.ReportingJob
	50,  // 162: cnspec.policy.v1.CollectorJob.ReportingQueriesEntry.value:type_name -> cnspec.policy.v1.StringArray
	51,  // 163: cnspec.policy.v1.CollectorJob.DatapointsEntry.value:type_name -> cnspec.policy.v1.DataQueryInfo
	50,  // 164: cnspec.policy.v1.CollectorJob.RiskMrnsEntry.value:type_name -> cnspec.policy.v1.StringArray
	31,  // 165: cnspec.policy.v1.CollectorJob.RiskFactorsEntry.value:type_name -> cnspec.policy.v1.RiskFactor
	130, // 166: cnspec.policy.v1.ReportingJob.ChildJobsEntry.value:type_name -> cnquery.explorer.Impact
	60,  // 167: cnspec.policy.v1.Report.ScoresEntry.value:type_name -> cnspec.policy.v1.Score
	140, // 168: cnspec.policy.v1.Report.DataEntry.value:type_name -> cnquery.llx.Result
	58,  // 169: cnspec.policy.v1.Report.CvssScoresEntry.value:type_name -> cnspec.policy.v1.Cvss
	139, // 170: cnspec.policy.v1.ReportCollection.AssetsEntry.value:type_name -> cnquery.providers.v1.Asset
	53,  // 171: cnspec.policy.v1.ReportCollection.ReportsEntry.value:type_name -> cnspec.policy.v1.Report
	46,  // 172: cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry.value:type_name -> cnspec.policy.v1.ResolvedPolicy
	141, // 173: cnspec.policy.v1.ReportCollection.VulnReportsEntry.value:type_name -> mondoo.mvd.v1.VulnReport
	78,  // 174: cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry.value:type_name -> cnspec.policy.v1.PolicyDelta
	140, // 175: cnspec.policy.v1.StoreResultsReq.DataEntry.value:type_name -> cnquery.llx.Result
	142, // 176: cnspec.policy.v1.StoreResultsReq.ResourcesEntry.value:type_name -> cnquery.llx.ResourceRecording
	88,  // 177: cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry.value:type_name -> cnspec.policy.v1.SynchronizeAssetsRespAssetDetail
	...
	71,  // 180: cnspec.policy.v1.PolicyHub.GetBundle:input_type -> cnspec.policy.v1.Mrn
	71,  // 181: cnspec.policy.v1.PolicyHub.GetPolicy:input_type -> cnspec.policy.v1.Mrn
	71,  // 182: cnspec.policy.v1.PolicyHub.DeletePolicy:input_type -> cnspec.policy.v1.Mrn
	71,  // 183: cnspec.policy.v1.PolicyHub.GetPolicyFilters:input_type -> cnspec.policy.v1.Mrn
	73,  // 184: cnspec.policy.v1.PolicyHub.List:input_type -> cnspec.policy.v1.ListReq
	74,  // 185: cnspec.policy.v1.PolicyHub.DefaultPolicies:input_type -> cnspec.policy.v1.DefaultPoliciesReq
	71,  // 186: cnspec.policy.v1.PolicyHub.GetFramework:input_type -> cnspec.policy.v1.Mrn
	71,  // 187: cnspec.policy.v1.PolicyHub.DeleteFramework:input_type -> cnspec.policy.v1.Mrn
	73,  // 188: cnspec.policy.v1.PolicyHub.ListFrameworks:input_type -> cnspec.policy.v1.ListReq
	76,  // 189: cnspec.policy.v1.PolicyResolver.Assign:input_type -> cnspec.policy.v1.PolicyAssignment
	76,  // 190: cnspec.policy.v1.PolicyResolver.Unassign:input_type -> cnspec.policy.v1.PolicyAssignment
	143, // 191: cnspec.policy.v1.PolicyResolver.SetProps:input_type -> cnquery.explorer.PropsReq
	79,  // 192: cnspec.policy.v1.PolicyResolver.Resolve:input_type -> cnspec.policy.v1.ResolveReq
	80,  // 193: cnspec.policy.v1.PolicyResolver.UpdateAssetJobs:input_type -> cnspec.policy.v1.UpdateAssetJobsReq
	80,  // 194: cnspec.policy.v1.PolicyResolver.ResolveAndUpdateJobs:input_type -> cnspec.policy.v1.UpdateAssetJobsReq
	71,  // 195: cnspec.policy.v1.PolicyResolver.GetResolvedPolicy:input_type -> cnspec.policy.v1.Mrn
	81,  // 196: cnspec.policy.v1.PolicyResolver.StoreResults:input_type -> cnspec.policy.v1.StoreResultsReq
	82,  // 197: cnspec.policy.v1.PolicyResolver.GetUploadURL:input_type -> cnspec.policy.v1.GetUploadURLReq
	85,  // 198: cnspec.policy.v1.PolicyResolver.ReportUploadCompleted:input_type -> cnspec.policy.v1.ReportUploadCompletedReq
	86,  // 199: cnspec.policy.v1.PolicyResolver.GetReport:input_type -> cnspec.policy.v1.EntityScoreReq
	86,  // 200: cnspec.policy.v1.PolicyResolver.GetFrameworkReport:input_type -> cnspec.policy.v1.EntityScoreReq
	86,  // 201: cnspec.policy.v1.PolicyResolver.GetScore:input_type -> cnspec.policy.v1.EntityScoreReq
	144, // 202: cnspec.policy.v1.PolicyResolver.GetResourcesData:input_type -> cnquery.explorer.resources.EntityResourcesReq
	87,  // 203: cnspec.policy.v1.PolicyResolver.SynchronizeAssets:input_type -> cnspec.policy.v1.SynchronizeAssetsReq
	90,  // 204: cnspec.policy.v1.PolicyResolver.PurgeAssets:input_type -> cnspec.policy.v1.PurgeAssetsRequest
	70,  // 205: cnspec.policy.v1.PolicyHub.SetBundle:output_type -> cnspec.policy.v1.Empty
	70,  // 206: cnspec.policy.v1.PolicyHub.ValidateBundle:output_type -> cnspec.policy.v1.Empty
	...
	70,  // 209: cnspec.policy.v1.PolicyHub.DeletePolicy:output_type -> cnspec.policy.v1.Empty
	72,  // 210: cnspec.policy.v1.PolicyHub.GetPolicyFilters:output_type -> cnspec.policy.v1.Mqueries
	17,  // 211: cnspec.policy.v1.PolicyHub.List:output_type -> cnspec.policy.v1.Policies
	75,  // 212: cnspec.policy.v1.PolicyHub.DefaultPolicies:output_type -> cnspec.policy.v1.URLs
	35,  // 213: cnspec.policy.v1.PolicyHub.GetFramework:output_type -> cnspec.policy.v1.Framework
	70,  // 214: cnspec.policy.v1.PolicyHub.DeleteFramework:output_type -> cnspec.policy.v1.Empty
	36,  // 215: cnspec.policy.v1.PolicyHub.ListFrameworks:output_type -> cnspec.policy.v1.Frameworks
	70,  // 216: cnspec.policy.v1.PolicyResolver.Assign:output_type -> cnspec.policy.v1.Empty
	70,  // 217: cnspec.policy.v1.PolicyResolver.Unassign:output_type -> cnspec.policy.v1.Empty
	145, // 218: cnspec.policy.v1.PolicyResolver.SetProps:output_type -> cnquery.explorer.Empty
	46,  // 219: cnspec.policy.v1.PolicyResolver.Resolve:output_type -> cnspec.policy.v1.ResolvedPolicy
	70,  // 220: cnspec.policy.v1.PolicyResolver.UpdateAssetJobs:output_type -> cnspec.policy.v1.Empty
	46,  // 221: cnspec.policy.v1.PolicyResolver.ResolveAndUpdateJobs:output_type -> cnspec.policy.v1.ResolvedPolicy
	46,  // 222: cnspec.policy.v1.PolicyResolver.GetResolvedPolicy:output_type -> cnspec.policy.v1.ResolvedPolicy
	70,  // 223: cnspec.policy.v1.PolicyResolver.StoreResults:output_type -> cnspec.policy.v1.Empty
	83,  // 224: cnspec.policy.v1.PolicyResolver.GetUploadURL:output_type -> cnspec.policy.v1.GetUploadURLResp
	70,  // 225: cnspec.policy.v1.PolicyResolver.ReportUploadCompleted:output_type -> cnspec.policy.v1.Empty
	53,  // 226: cnspec.policy.v1.PolicyResolver.GetReport:output_type -> cnspec.policy.v1.Report
	56,  // 227: cnspec.policy.v1.PolicyResolver.GetFrameworkReport:output_type -> cnspec.policy.v1.FrameworkReport
	53,  // 228: cnspec.policy.v1.PolicyResolver.GetScore:output_type -> cnspec.policy.v1.Report
	146, // 229: cnspec.policy.v1.PolicyResolver.GetResourcesData:output_type -> cnquery.explorer.resources.EntityResourcesRes
	89,  // 230: cnspec.policy.v1.PolicyResolver.SynchronizeAssets:output_type -> cnspec.policy.v1.SynchronizeAssetsResp
	92,  // 231: cnspec.policy.v1.PolicyResolver.PurgeAssets:output_type -> cnspec.policy.v1.PurgeAssetsConfirmation
