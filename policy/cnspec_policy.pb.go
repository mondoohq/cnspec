...
func (Migration_Action) EnumDescriptor() ([]byte, []int) {
	return file_cnspec_policy_proto_rawDescGZIP(), []int{13, 0}
}
...
func (ReportingJob_Type) EnumDescriptor() ([]byte, []int) {
	return file_cnspec_policy_proto_rawDescGZIP(), []int{40, 0}
}
...
func (PolicyDelta_PolicyAssignmentActionType) EnumDescriptor() ([]byte, []int) {
	return file_cnspec_policy_proto_rawDescGZIP(), []int{66, 0}
}
...
const file_cnspec_policy_proto_rawDesc = "" +
	...
	"\x11policy_migrations\x18\x03 \x03(\v2\x1b.cnspec.policy.v1.MigrationR\x10policyMigrations\"\xfc\x01\n" +
	"\tMigration\x129\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x124\n" +
	"\x05value\x18\x02 \x01(\v2\x1e.cnquery.llx.ResourceRecordingR\x05value:\x028\x01\"c\n" +
...
var file_cnspec_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 113)
var file_cnspec_policy_proto_goTypes = []any{
	...
	(UploadURLKind)(0),     // 5: cnspec.policy.v1.UploadURLKind
	(ScoreRating)(0),       // 6: cnspec.policy.v1.ScoreRating
	(Comparison)(0),        // 7: cnspec.policy.v1.Comparison
	(DateFilterField)(0),   // 8: cnspec.policy.v1.DateFilterField
	(Migration_Action)(0),  // 9: cnspec.policy.v1.Migration.Action
	(ReportingJob_Type)(0), // 10: cnspec.policy.v1.ReportingJob.Type
	(PolicyDelta_PolicyAssignmentActionType)(0), // 11: cnspec.policy.v1.PolicyDelta.PolicyAssignmentActionType
	(Source_Vendor)(0),                          // 12: cnspec.policy.v1.Source.Vendor
	(*PolicyGroup)(nil),                         // 13: cnspec.policy.v1.PolicyGroup
	(*Validity)(nil),                            // 14: cnspec.policy.v1.Validity
	(*PolicyRef)(nil),                           // 15: cnspec.policy.v1.PolicyRef
	(*Policy)(nil),                              // 16: cnspec.policy.v1.Policy
	(*Policies)(nil),                            // 17: cnspec.policy.v1.Policies
	(*Requirement)(nil),                         // 18: cnspec.policy.v1.Requirement
	(*QueryCounts)(nil),                         // 19: cnspec.policy.v1.QueryCounts
	(*Bundle)(nil),                              // 20: cnspec.policy.v1.Bundle
	(*MigrationPolicyRef)(nil),                  // 21: cnspec.policy.v1.MigrationPolicyRef
	(*MigrationGroup)(nil),                      // 22: cnspec.policy.v1.MigrationGroup
	(*MigrationConditions)(nil),                 // 23: cnspec.policy.v1.MigrationConditions
	(*MigrationMetadata)(nil),                   // 24: cnspec.policy.v1.MigrationMetadata
	(*MigrationStage)(nil),                      // 25: cnspec.policy.v1.MigrationStage
	(*Migration)(nil),                           // 26: cnspec.policy.v1.Migration
	(*MigrationSource)(nil),                     // 27: cnspec.policy.v1.MigrationSource
	(*MigrationTarget)(nil),                     // 28: cnspec.policy.v1.MigrationTarget
	(*SoftwareSelector)(nil),                    // 29: cnspec.policy.v1.SoftwareSelector
	(*ResourceSelector)(nil),                    // 30: cnspec.policy.v1.ResourceSelector
	(*RiskMagnitude)(nil),                       // 31: cnspec.policy.v1.RiskMagnitude
	(*RiskFactor)(nil),                          // 32: cnspec.policy.v1.RiskFactor
	(*RiskFactorDocs)(nil),                      // 33: cnspec.policy.v1.RiskFactorDocs
	(*PolicyGroupDocs)(nil),                     // 34: cnspec.policy.v1.PolicyGroupDocs
	(*PolicyDocs)(nil),                          // 35: cnspec.policy.v1.PolicyDocs
	(*Framework)(nil),                           // 36: cnspec.policy.v1.Framework
	(*Frameworks)(nil),                          // 37: cnspec.policy.v1.Frameworks
	(*FrameworkGroup)(nil),                      // 38: cnspec.policy.v1.FrameworkGroup
	(*FrameworkRef)(nil),                        // 39: cnspec.policy.v1.FrameworkRef
	(*Evidence)(nil),                            // 40: cnspec.policy.v1.Evidence
	(*Control)(nil),                             // 41: cnspec.policy.v1.Control
	(*FrameworkMap)(nil),                        // 42: cnspec.policy.v1.FrameworkMap
	(*ControlMap)(nil),                          // 43: cnspec.policy.v1.ControlMap
	(*ControlDocs)(nil),                         // 44: cnspec.policy.v1.ControlDocs
	(*ControlRef)(nil),                          // 45: cnspec.policy.v1.ControlRef
	(*Asset)(nil),                               // 46: cnspec.policy.v1.Asset
	(*ResolvedPolicy)(nil),                      // 47: cnspec.policy.v1.ResolvedPolicy
	(*ExecutionJob)(nil),                        // 48: cnspec.policy.v1.ExecutionJob
	(*ExecutionQuery)(nil),                      // 49: cnspec.policy.v1.ExecutionQuery
	(*CollectorJob)(nil),                        // 50: cnspec.policy.v1.CollectorJob
	(*StringArray)(nil),                         // 51: cnspec.policy.v1.StringArray
	(*DataQueryInfo)(nil),                       // 52: cnspec.policy.v1.DataQueryInfo
	(*ReportingJob)(nil),                        // 53: cnspec.policy.v1.ReportingJob
	(*Report)(nil),                              // 54: cnspec.policy.v1.Report
	(*Reports)(nil),                             // 55: cnspec.policy.v1.Reports
	(*ReportCollection)(nil),                    // 56: cnspec.policy.v1.ReportCollection
	(*FrameworkReport)(nil),                     // 57: cnspec.policy.v1.FrameworkReport
	(*ControlScore)(nil),                        // 58: cnspec.policy.v1.ControlScore
	(*Cvss)(nil),                                // 59: cnspec.policy.v1.Cvss
	(*CvssStats)(nil),                           // 60: cnspec.policy.v1.CvssStats
	(*Score)(nil),                               // 61: cnspec.policy.v1.Score
	(*ScoreDelta)(nil),                          // 62: cnspec.policy.v1.ScoreDelta
	(*ScoredRiskFactor)(nil),                    // 63: cnspec.policy.v1.ScoredRiskFactor
	(*ScoredRiskFactors)(nil),                   // 64: cnspec.policy.v1.ScoredRiskFactors
	(*RiskFactorStats)(nil),                     // 65: cnspec.policy.v1.RiskFactorStats
	(*RiskFactorsStats)(nil),                    // 66: cnspec.policy.v1.RiskFactorsStats
	(*Stats)(nil),                               // 67: cnspec.policy.v1.Stats
	(*ScoreDistribution)(nil),                   // 68: cnspec.policy.v1.ScoreDistribution
	(*ScoreStats)(nil),                          // 69: cnspec.policy.v1.ScoreStats
	(*AssetFindingsStats)(nil),                  // 70: cnspec.policy.v1.AssetFindingsStats
	(*Empty)(nil),                               // 71: cnspec.policy.v1.Empty
	(*Mrn)(nil),                                 // 72: cnspec.policy.v1.Mrn
	(*Mqueries)(nil),                            // 73: cnspec.policy.v1.Mqueries
	(*ListReq)(nil),                             // 74: cnspec.policy.v1.ListReq
	(*DefaultPoliciesReq)(nil),                  // 75: cnspec.policy.v1.DefaultPoliciesReq
	(*URLs)(nil),                                // 76: cnspec.policy.v1.URLs
	(*PolicyAssignment)(nil),                    // 77: cnspec.policy.v1.PolicyAssignment
	(*PolicyMutationDelta)(nil),                 // 78: cnspec.policy.v1.PolicyMutationDelta
	(*PolicyDelta)(nil),                         // 79: cnspec.policy.v1.PolicyDelta
	(*ResolveReq)(nil),                          // 80: cnspec.policy.v1.ResolveReq
	(*UpdateAssetJobsReq)(nil),                  // 81: cnspec.policy.v1.UpdateAssetJobsReq
	(*StoreResultsReq)(nil),                     // 82: cnspec.policy.v1.StoreResultsReq
	(*GetUploadURLReq)(nil),                     // 83: cnspec.policy.v1.GetUploadURLReq
	(*GetUploadURLResp)(nil),                    // 84: cnspec.policy.v1.GetUploadURLResp
	(*UploadURL)(nil),                           // 85: cnspec.policy.v1.UploadURL
	(*ReportUploadCompletedReq)(nil),            // 86: cnspec.policy.v1.ReportUploadCompletedReq
	(*EntityScoreReq)(nil),                      // 87: cnspec.policy.v1.EntityScoreReq
	(*SynchronizeAssetsReq)(nil),                // 88: cnspec.policy.v1.SynchronizeAssetsReq
	(*SynchronizeAssetsRespAssetDetail)(nil),    // 89: cnspec.policy.v1.SynchronizeAssetsRespAssetDetail
	(*SynchronizeAssetsResp)(nil),               // 90: cnspec.policy.v1.SynchronizeAssetsResp
	(*PurgeAssetsRequest)(nil),                  // 91: cnspec.policy.v1.PurgeAssetsRequest
	(*DateFilter)(nil),                          // 92: cnspec.policy.v1.DateFilter
	(*PurgeAssetsConfirmation)(nil),             // 93: cnspec.policy.v1.PurgeAssetsConfirmation
	(*Sources)(nil),                             // 94: cnspec.policy.v1.Sources
	(*Source)(nil),                              // 95: cnspec.policy.v1.Source
	nil,                                         // 96: cnspec.policy.v1.Policy.TagsEntry
	nil,                                         // 97: cnspec.policy.v1.MigrationMetadata.LabelsEntry
	nil,                                         // 98: cnspec.policy.v1.RiskFactor.TagsEntry
	nil,                                         // 99: cnspec.policy.v1.Framework.TagsEntry
	nil,                                         // 100: cnspec.policy.v1.Control.TagsEntry
	nil,                                         // 101: cnspec.policy.v1.ExecutionJob.QueriesEntry
	nil,                                         // 102: cnspec.policy.v1.ExecutionQuery.PropertiesEntry
	nil,                                         // 103: cnspec.policy.v1.CollectorJob.ReportingJobsEntry
	nil,                                         // 104: cnspec.policy.v1.CollectorJob.ReportingQueriesEntry
	nil,                                         // 105: cnspec.policy.v1.CollectorJob.DatapointsEntry
	nil,                                         // 106: cnspec.policy.v1.CollectorJob.RiskMrnsEntry
	nil,                                         // 107: cnspec.policy.v1.CollectorJob.RiskFactorsEntry
	nil,                                         // 108: cnspec.policy.v1.ReportingJob.DatapointsEntry
	nil,                                         // 109: cnspec.policy.v1.ReportingJob.ChildJobsEntry
	nil,                                         // 110: cnspec.policy.v1.Report.ScoresEntry
	nil,                                         // 111: cnspec.policy.v1.Report.DataEntry
	nil,                                         // 112: cnspec.policy.v1.Report.CvssScoresEntry
	nil,                                         // 113: cnspec.policy.v1.ReportCollection.AssetsEntry
	nil,                                         // 114: cnspec.policy.v1.ReportCollection.ReportsEntry
	nil,                                         // 115: cnspec.policy.v1.ReportCollection.ErrorsEntry
	nil,                                         // 116: cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry
	nil,                                         // 117: cnspec.policy.v1.ReportCollection.VulnReportsEntry
	nil,                                         // 118: cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry
	nil,                                         // 119: cnspec.policy.v1.StoreResultsReq.DataEntry
	nil,                                         // 120: cnspec.policy.v1.StoreResultsReq.ResourcesEntry
	nil,                                         // 121: cnspec.policy.v1.UploadURL.HeadersEntry
	nil,                                         // 122: cnspec.policy.v1.SynchronizeAssetsRespAssetDetail.AnnotationsEntry
	nil,                                         // 123: cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry
	nil,                                         // 124: cnspec.policy.v1.PurgeAssetsRequest.LabelsEntry
	nil,                                         // 125: cnspec.policy.v1.PurgeAssetsConfirmation.ErrorsEntry
	(*explorer.Mquery)(nil),                     // 126: cnquery.explorer.Mquery
	(*explorer.Filters)(nil),                    // 127: cnquery.explorer.Filters
	(*explorer.Author)(nil),                     // 128: cnquery.explorer.Author
	(*explorer.HumanTime)(nil),                  // 129: cnquery.explorer.HumanTime
	(explorer.Action)(0),                        // 130: cnquery.explorer.Action
	(*explorer.Impact)(nil),                     // 131: cnquery.explorer.Impact
	(explorer.ScoringSystem)(0),                 // 132: cnquery.explorer.ScoringSystem
	(*explorer.Property)(nil),                   // 133: cnquery.explorer.Property
	(*explorer.QueryPack)(nil),                  // 134: cnquery.explorer.QueryPack
	(*timestamppb.Timestamp)(nil),               // 135: google.protobuf.Timestamp
	(*explorer.ObjectRef)(nil),                  // 136: cnquery.explorer.ObjectRef
	(*explorer.MqueryRef)(nil),                  // 137: cnquery.explorer.MqueryRef
	(*inventory.Platform)(nil),                  // 138: cnquery.providers.v1.Platform
	(*llx.CodeBundle)(nil),                      // 139: cnquery.llx.CodeBundle
	(*inventory.Asset)(nil),                     // 140: cnquery.providers.v1.Asset
	(*llx.Result)(nil),                          // 141: cnquery.llx.Result
	(*mvd.VulnReport)(nil),                      // 142: mondoo.mvd.v1.VulnReport
	(*llx.ResourceRecording)(nil),               // 143: cnquery.llx.ResourceRecording
	(*explorer.PropsReq)(nil),                   // 144: cnquery.explorer.PropsReq
	(*resources.EntityResourcesReq)(nil),        // 145: cnquery.explorer.resources.EntityResourcesReq
	(*explorer.Empty)(nil),                      // 146: cnquery.explorer.Empty
	(*resources.EntityResourcesRes)(nil),        // 147: cnquery.explorer.resources.EntityResourcesRes
}
var file_cnspec_policy_proto_depIdxs = []int32{
	...
	126, // 1: cnspec.policy.v1.PolicyGroup.checks:type_name -> cnquery.explorer.Mquery
	126, // 2: cnspec.policy.v1.PolicyGroup.queries:type_name -> cnquery.explorer.Mquery
	0,   // 3: cnspec.policy.v1.PolicyGroup.type:type_name -> cnspec.policy.v1.GroupType
	127, // 4: cnspec.policy.v1.PolicyGroup.filters:type_name -> cnquery.explorer.Filters
	14,  // 5: cnspec.policy.v1.PolicyGroup.valid:type_name -> cnspec.policy.v1.Validity
	34,  // 6: cnspec.policy.v1.PolicyGroup.docs:type_name -> cnspec.policy.v1.PolicyGroupDocs
	128, // 7: cnspec.policy.v1.PolicyGroup.authors:type_name -> cnquery.explorer.Author
	128, // 8: cnspec.policy.v1.PolicyGroup.reviewers:type_name -> cnquery.explorer.Author
	3,   // 9: cnspec.policy.v1.PolicyGroup.review_status:type_name -> cnspec.policy.v1.ReviewStatus
	129, // 10: cnspec.policy.v1.Validity.from:type_name -> cnquery.explorer.HumanTime
	129, // 11: cnspec.policy.v1.Validity.until:type_name -> cnquery.explorer.HumanTime
	130, // 12: cnspec.policy.v1.PolicyRef.action:type_name -> cnquery.explorer.Action
	131, // 13: cnspec.policy.v1.PolicyRef.impact:type_name -> cnquery.explorer.Impact
	132, // 14: cnspec.policy.v1.PolicyRef.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	13,  // 15: cnspec.policy.v1.Policy.groups:type_name -> cnspec.policy.v1.PolicyGroup
	35,  // 16: cnspec.policy.v1.Policy.docs:type_name -> cnspec.policy.v1.PolicyDocs
	132, // 17: cnspec.policy.v1.Policy.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	128, // 18: cnspec.policy.v1.Policy.authors:type_name -> cnquery.explorer.Author
	96,  // 19: cnspec.policy.v1.Policy.tags:type_name -> cnspec.policy.v1.Policy.TagsEntry
	133, // 20: cnspec.policy.v1.Policy.props:type_name -> cnquery.explorer.Property
	32,  // 21: cnspec.policy.v1.Policy.risk_factors:type_name -> cnspec.policy.v1.RiskFactor
	18,  // 22: cnspec.policy.v1.Policy.require:type_name -> cnspec.policy.v1.Requirement
	127, // 23: cnspec.policy.v1.Policy.computed_filters:type_name -> cnquery.explorer.Filters
	...
	134, // 27: cnspec.policy.v1.Bundle.packs:type_name -> cnquery.explorer.QueryPack
	133, // 28: cnspec.policy.v1.Bundle.props:type_name -> cnquery.explorer.Property
	126, // 29: cnspec.policy.v1.Bundle.queries:type_name -> cnquery.explorer.Mquery
	36,  // 30: cnspec.policy.v1.Bundle.frameworks:type_name -> cnspec.policy.v1.Framework
	42,  // 31: cnspec.policy.v1.Bundle.framework_maps:type_name -> cnspec.policy.v1.FrameworkMap
	35,  // 32: cnspec.policy.v1.Bundle.docs:type_name -> cnspec.policy.v1.PolicyDocs
	22,  // 33: cnspec.policy.v1.Bundle.migration_groups:type_name -> cnspec.policy.v1.MigrationGroup
	26,  // 34: cnspec.policy.v1.MigrationGroup.migrations:type_name -> cnspec.policy.v1.Migration
	23,  // 35: cnspec.policy.v1.MigrationGroup.conditions:type_name -> cnspec.policy.v1.MigrationConditions
	25,  // 36: cnspec.policy.v1.MigrationGroup.stages:type_name -> cnspec.policy.v1.MigrationStage
	24,  // 37: cnspec.policy.v1.MigrationGroup.metadata:type_name -> cnspec.policy.v1.MigrationMetadata
	21,  // 38: cnspec.policy.v1.MigrationConditions.source_policy:type_name -> cnspec.policy.v1.MigrationPolicyRef
	21,  // 39: cnspec.policy.v1.MigrationConditions.target_policy:type_name -> cnspec.policy.v1.MigrationPolicyRef
	135, // 40: cnspec.policy.v1.MigrationMetadata.created_at:type_name -> google.protobuf.Timestamp
	97,  // 41: cnspec.policy.v1.MigrationMetadata.labels:type_name -> cnspec.policy.v1.MigrationMetadata.LabelsEntry
	26,  // 42: cnspec.policy.v1.MigrationStage.query_migrations:type_name -> cnspec.policy.v1.Migration
	26,  // 43: cnspec.policy.v1.MigrationStage.policy_migrations:type_name -> cnspec.policy.v1.Migration
	27,  // 44: cnspec.policy.v1.Migration.source:type_name -> cnspec.policy.v1.MigrationSource
	28,  // 45: cnspec.policy.v1.Migration.target:type_name -> cnspec.policy.v1.MigrationTarget
	9,   // 46: cnspec.policy.v1.Migration.action:type_name -> cnspec.policy.v1.Migration.Action
	33,  // 47: cnspec.policy.v1.RiskFactor.docs:type_name -> cnspec.policy.v1.RiskFactorDocs
	127, // 48: cnspec.policy.v1.RiskFactor.filters:type_name -> cnquery.explorer.Filters
	126, // 49: cnspec.policy.v1.RiskFactor.checks:type_name -> cnquery.explorer.Mquery
	2,   // 50: cnspec.policy.v1.RiskFactor.scope:type_name -> cnspec.policy.v1.ScopeType
	31,  // 51: cnspec.policy.v1.RiskFactor.magnitude:type_name -> cnspec.policy.v1.RiskMagnitude
	29,  // 52: cnspec.policy.v1.RiskFactor.software:type_name -> cnspec.policy.v1.SoftwareSelector
	30,  // 53: cnspec.policy.v1.RiskFactor.resources:type_name -> cnspec.policy.v1.ResourceSelector
	130, // 54: cnspec.policy.v1.RiskFactor.action:type_name -> cnquery.explorer.Action
	98,  // 55: cnspec.policy.v1.RiskFactor.tags:type_name -> cnspec.policy.v1.RiskFactor.TagsEntry
	38,  // 56: cnspec.policy.v1.Framework.groups:type_name -> cnspec.policy.v1.FrameworkGroup
	35,  // 57: cnspec.policy.v1.Framework.docs:type_name -> cnspec.policy.v1.PolicyDocs
	128, // 58: cnspec.policy.v1.Framework.authors:type_name -> cnquery.explorer.Author
	99,  // 59: cnspec.policy.v1.Framework.tags:type_name -> cnspec.policy.v1.Framework.TagsEntry
	39,  // 60: cnspec.policy.v1.Framework.dependencies:type_name -> cnspec.policy.v1.FrameworkRef
	42,  // 61: cnspec.policy.v1.Framework.framework_maps:type_name -> cnspec.policy.v1.FrameworkMap
	36,  // 62: cnspec.policy.v1.Frameworks.items:type_name -> cnspec.policy.v1.Framework
	41,  // 63: cnspec.policy.v1.FrameworkGroup.controls:type_name -> cnspec.policy.v1.Control
	0,   // 64: cnspec.policy.v1.FrameworkGroup.type:type_name -> cnspec.policy.v1.GroupType
	34,  // 65: cnspec.policy.v1.FrameworkGroup.docs:type_name -> cnspec.policy.v1.PolicyGroupDocs
	128, // 66: cnspec.policy.v1.FrameworkGroup.authors:type_name -> cnquery.explorer.Author
	128, // 67: cnspec.policy.v1.FrameworkGroup.reviewers:type_name -> cnquery.explorer.Author
	3,   // 68: cnspec.policy.v1.FrameworkGroup.review_status:type_name -> cnspec.policy.v1.ReviewStatus
	130, // 69: cnspec.policy.v1.FrameworkRef.action:type_name -> cnquery.explorer.Action
	126, // 70: cnspec.policy.v1.Evidence.checks:type_name -> cnquery.explorer.Mquery
	126, // 71: cnspec.policy.v1.Evidence.queries:type_name -> cnquery.explorer.Mquery
	45,  // 72: cnspec.policy.v1.Evidence.controls:type_name -> cnspec.policy.v1.ControlRef
	44,  // 73: cnspec.policy.v1.Control.docs:type_name -> cnspec.policy.v1.ControlDocs
	100, // 74: cnspec.policy.v1.Control.tags:type_name -> cnspec.policy.v1.Control.TagsEntry
	130, // 75: cnspec.policy.v1.Control.action:type_name -> cnquery.explorer.Action
	40,  // 76: cnspec.policy.v1.Control.evidence:type_name -> cnspec.policy.v1.Evidence
	136, // 77: cnspec.policy.v1.FrameworkMap.framework_dependencies:type_name -> cnquery.explorer.ObjectRef
	136, // 78: cnspec.policy.v1.FrameworkMap.policy_dependencies:type_name -> cnquery.explorer.ObjectRef
	136, // 79: cnspec.policy.v1.FrameworkMap.query_pack_dependencies:type_name -> cnquery.explorer.ObjectRef
	43,  // 80: cnspec.policy.v1.FrameworkMap.controls:type_name -> cnspec.policy.v1.ControlMap
	136, // 81: cnspec.policy.v1.FrameworkMap.framework_owner:type_name -> cnquery.explorer.ObjectRef
	45,  // 82: cnspec.policy.v1.ControlMap.checks:type_name -> cnspec.policy.v1.ControlRef
	45,  // 83: cnspec.policy.v1.ControlMap.policies:type_name -> cnspec.policy.v1.ControlRef
	45,  // 84: cnspec.policy.v1.ControlMap.controls:type_name -> cnspec.policy.v1.ControlRef
	45,  // 85: cnspec.policy.v1.ControlMap.queries:type_name -> cnspec.policy.v1.ControlRef
	137, // 86: cnspec.policy.v1.ControlDocs.refs:type_name -> cnquery.explorer.MqueryRef
	130, // 87: cnspec.policy.v1.ControlRef.action:type_name -> cnquery.explorer.Action
	138, // 88: cnspec.policy.v1.Asset.platform:type_name -> cnquery.providers.v1.Platform
	48,  // 89: cnspec.policy.v1.ResolvedPolicy.execution_job:type_name -> cnspec.policy.v1.ExecutionJob
	50,  // 90: cnspec.policy.v1.ResolvedPolicy.collector_job:type_name -> cnspec.policy.v1.CollectorJob
	126, // 91: cnspec.policy.v1.ResolvedPolicy.filters:type_name -> cnquery.explorer.Mquery
	4,   // 92: cnspec.policy.v1.ResolvedPolicy.features:type_name -> cnspec.policy.v1.ServerFeature
	101, // 93: cnspec.policy.v1.ExecutionJob.queries:type_name -> cnspec.policy.v1.ExecutionJob.QueriesEntry
	102, // 94: cnspec.policy.v1.ExecutionQuery.properties:type_name -> cnspec.policy.v1.ExecutionQuery.PropertiesEntry
	139, // 95: cnspec.policy.v1.ExecutionQuery.code:type_name -> cnquery.llx.CodeBundle
	103, // 96: cnspec.policy.v1.CollectorJob.reporting_jobs:type_name -> cnspec.policy.v1.CollectorJob.ReportingJobsEntry
	104, // 97: cnspec.policy.v1.CollectorJob.reporting_queries:type_name -> cnspec.policy.v1.CollectorJob.ReportingQueriesEntry
	105, // 98: cnspec.policy.v1.CollectorJob.datapoints:type_name -> cnspec.policy.v1.CollectorJob.DatapointsEntry
	106, // 99: cnspec.policy.v1.CollectorJob.risk_mrns:type_name -> cnspec.policy.v1.CollectorJob.RiskMrnsEntry
	107, // 100: cnspec.policy.v1.CollectorJob.risk_factors:type_name -> cnspec.policy.v1.CollectorJob.RiskFactorsEntry
	132, // 101: cnspec.policy.v1.ReportingJob.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	108, // 102: cnspec.policy.v1.ReportingJob.datapoints:type_name -> cnspec.policy.v1.ReportingJob.DatapointsEntry
	109, // 103: cnspec.policy.v1.ReportingJob.child_jobs:type_name -> cnspec.policy.v1.ReportingJob.ChildJobsEntry
	10,  // 104: cnspec.policy.v1.ReportingJob.type:type_name -> cnspec.policy.v1.ReportingJob.Type
	61,  // 105: cnspec.policy.v1.Report.score:type_name -> cnspec.policy.v1.Score
	110, // 106: cnspec.policy.v1.Report.scores:type_name -> cnspec.policy.v1.Report.ScoresEntry
	111, // 107: cnspec.policy.v1.Report.data:type_name -> cnspec.policy.v1.Report.DataEntry
	67,  // 108: cnspec.policy.v1.Report.stats:type_name -> cnspec.policy.v1.Stats
	64,  // 109: cnspec.policy.v1.Report.risks:type_name -> cnspec.policy.v1.ScoredRiskFactors
	67,  // 110: cnspec.policy.v1.Report.ignored_stats:type_name -> cnspec.policy.v1.Stats
	59,  // 111: cnspec.policy.v1.Report.cvss_score:type_name -> cnspec.policy.v1.Cvss
	112, // 112: cnspec.policy.v1.Report.cvss_scores:type_name -> cnspec.policy.v1.Report.CvssScoresEntry
	60,  // 113: cnspec.policy.v1.Report.cvss_stats:type_name -> cnspec.policy.v1.CvssStats
	54,  // 114: cnspec.policy.v1.Reports.reports:type_name -> cnspec.policy.v1.Report
	113, // 115: cnspec.policy.v1.ReportCollection.assets:type_name -> cnspec.policy.v1.ReportCollection.AssetsEntry
	20,  // 116: cnspec.policy.v1.ReportCollection.bundle:type_name -> cnspec.policy.v1.Bundle
	114, // 117: cnspec.policy.v1.ReportCollection.reports:type_name -> cnspec.policy.v1.ReportCollection.ReportsEntry
	115, // 118: cnspec.policy.v1.ReportCollection.errors:type_name -> cnspec.policy.v1.ReportCollection.ErrorsEntry
	116, // 119: cnspec.policy.v1.ReportCollection.resolved_policies:type_name -> cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry
	117, // 120: cnspec.policy.v1.ReportCollection.vuln_reports:type_name -> cnspec.policy.v1.ReportCollection.VulnReportsEntry
	58,  // 121: cnspec.policy.v1.FrameworkReport.score:type_name -> cnspec.policy.v1.ControlScore
	58,  // 122: cnspec.policy.v1.FrameworkReport.controls:type_name -> cnspec.policy.v1.ControlScore
	58,  // 123: cnspec.policy.v1.ControlScore.assets:type_name -> cnspec.policy.v1.ControlScore
	68,  // 124: cnspec.policy.v1.ControlScore.scores:type_name -> cnspec.policy.v1.ScoreDistribution
	64,  // 125: cnspec.policy.v1.Score.risk_factors:type_name -> cnspec.policy.v1.ScoredRiskFactors
	95,  // 126: cnspec.policy.v1.Score.source:type_name -> cnspec.policy.v1.Source
	94,  // 127: cnspec.policy.v1.Score.sources:type_name -> cnspec.policy.v1.Sources
	63,  // 128: cnspec.policy.v1.ScoredRiskFactors.items:type_name -> cnspec.policy.v1.ScoredRiskFactor
	65,  // 129: cnspec.policy.v1.RiskFactorsStats.items:type_name -> cnspec.policy.v1.RiskFactorStats
	68,  // 130: cnspec.policy.v1.Stats.failed:type_name -> cnspec.policy.v1.ScoreDistribution
	68,  // 131: cnspec.policy.v1.Stats.passed:type_name -> cnspec.policy.v1.ScoreDistribution
	68,  // 132: cnspec.policy.v1.Stats.errors:type_name -> cnspec.policy.v1.ScoreDistribution
	69,  // 133: cnspec.policy.v1.AssetFindingsStats.score_stats:type_name -> cnspec.policy.v1.ScoreStats
	66,  // 134: cnspec.policy.v1.AssetFindingsStats.risk_factors:type_name -> cnspec.policy.v1.RiskFactorsStats
	126, // 135: cnspec.policy.v1.Mqueries.items:type_name -> cnquery.explorer.Mquery
	130, // 136: cnspec.policy.v1.PolicyAssignment.action:type_name -> cnquery.explorer.Action
	132, // 137: cnspec.policy.v1.PolicyAssignment.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	118, // 138: cnspec.policy.v1.PolicyMutationDelta.policy_deltas:type_name -> cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry
	130, // 139: cnspec.policy.v1.PolicyMutationDelta.action:type_name -> cnquery.explorer.Action
	11,  // 140: cnspec.policy.v1.PolicyDelta.action:type_name -> cnspec.policy.v1.PolicyDelta.PolicyAssignmentActionType
	132, // 141: cnspec.policy.v1.PolicyDelta.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	126, // 142: cnspec.policy.v1.ResolveReq.asset_filters:type_name -> cnquery.explorer.Mquery
	126, // 143: cnspec.policy.v1.UpdateAssetJobsReq.asset_filters:type_name -> cnquery.explorer.Mquery
	61,  // 144: cnspec.policy.v1.StoreResultsReq.scores:type_name -> cnspec.policy.v1.Score
	119, // 145: cnspec.policy.v1.StoreResultsReq.data:type_name -> cnspec.policy.v1.StoreResultsReq.DataEntry
	120, // 146: cnspec.policy.v1.StoreResultsReq.resources:type_name -> cnspec.policy.v1.StoreResultsReq.ResourcesEntry
	63,  // 147: cnspec.policy.v1.StoreResultsReq.risks:type_name -> cnspec.policy.v1.ScoredRiskFactor
	59,  // 148: cnspec.policy.v1.StoreResultsReq.cvssScores:type_name -> cnspec.policy.v1.Cvss
	5,   // 149: cnspec.policy.v1.GetUploadURLReq.kind:type_name -> cnspec.policy.v1.UploadURLKind
	85,  // 150: cnspec.policy.v1.GetUploadURLResp.upload_url:type_name -> cnspec.policy.v1.UploadURL
	121, // 151: cnspec.policy.v1.UploadURL.headers:type_name -> cnspec.policy.v1.UploadURL.HeadersEntry
	140, // 152: cnspec.policy.v1.SynchronizeAssetsReq.list:type_name -> cnquery.providers.v1.Asset
	122, // 153: cnspec.policy.v1.SynchronizeAssetsRespAssetDetail.annotations:type_name -> cnspec.policy.v1.SynchronizeAssetsRespAssetDetail.AnnotationsEntry
	123, // 154: cnspec.policy.v1.SynchronizeAssetsResp.details:type_name -> cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry
	92,  // 155: cnspec.policy.v1.PurgeAssetsRequest.date_filter:type_name -> cnspec.policy.v1.DateFilter
	124, // 156: cnspec.policy.v1.PurgeAssetsRequest.labels:type_name -> cnspec.policy.v1.PurgeAssetsRequest.LabelsEntry
	7,   // 157: cnspec.policy.v1.DateFilter.comparison:type_name -> cnspec.policy.v1.Comparison
	8,   // 158: cnspec.policy.v1.DateFilter.field:type_name -> cnspec.policy.v1.DateFilterField
	125, // 159: cnspec.policy.v1.PurgeAssetsConfirmation.errors:type_name -> cnspec.policy.v1.PurgeAssetsConfirmation.ErrorsEntry
	95,  // 160: cnspec.policy.v1.Sources.items:type_name -> cnspec.policy.v1.Source
	12,  // 161: cnspec.policy.v1.Source.vendor:type_name -> cnspec.policy.v1.Source.Vendor
	49,  // 162: cnspec.policy.v1.ExecutionJob.QueriesEntry.value:type_name -> cnspec.policy.v1.ExecutionQuery
	53,  // 163: cnspec.policy.v1.CollectorJob.ReportingJobsEntry.value:type_name -> cnspec.policy.v1.ReportingJob
	51,  // 164: cnspec.policy.v1.CollectorJob.ReportingQueriesEntry.value:type_name -> cnspec.policy.v1.StringArray
	52,  // 165: cnspec.policy.v1.CollectorJob.DatapointsEntry.value:type_name -> cnspec.policy.v1.DataQueryInfo
	51,  // 166: cnspec.policy.v1.CollectorJob.RiskMrnsEntry.value:type_name -> cnspec.policy.v1.StringArray
	32,  // 167: cnspec.policy.v1.CollectorJob.RiskFactorsEntry.value:type_name -> cnspec.policy.v1.RiskFactor
	131, // 168: cnspec.policy.v1.ReportingJob.ChildJobsEntry.value:type_name -> cnquery.explorer.Impact
	61,  // 169: cnspec.policy.v1.Report.ScoresEntry.value:type_name -> cnspec.policy.v1.Score
	141, // 170: cnspec.policy.v1.Report.DataEntry.value:type_name -> cnquery.llx.Result
	59,  // 171: cnspec.policy.v1.Report.CvssScoresEntry.value:type_name -> cnspec.policy.v1.Cvss
	140, // 172: cnspec.policy.v1.ReportCollection.AssetsEntry.value:type_name -> cnquery.providers.v1.Asset
	54,  // 173: cnspec.policy.v1.ReportCollection.ReportsEntry.value:type_name -> cnspec.policy.v1.Report
	47,  // 174: cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry.value:type_name -> cnspec.policy.v1.ResolvedPolicy
	142, // 175: cnspec.policy.v1.ReportCollection.VulnReportsEntry.value:type_name -> mondoo.mvd.v1.VulnReport
	79,  // 176: cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry.value:type_name -> cnspec.policy.v1.PolicyDelta
	141, // 177: cnspec.policy.v1.StoreResultsReq.DataEntry.value:type_name -> cnquery.llx.Result
	143, // 178: cnspec.policy.v1.StoreResultsReq.ResourcesEntry.value:type_name -> cnquery.llx.ResourceRecording
	89,  // 179: cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry.value:type_name -> cnspec.policy.v1.SynchronizeAssetsRespAssetDetail
	20,  // 180: cnspec.policy.v1.PolicyHub.SetBundle:input_type -> cnspec.policy.v1.Bundle
	20,  // 181: cnspec.policy.v1.PolicyHub.ValidateBundle:input_type -> cnspec.policy.v1.Bundle
	72,  // 182: cnspec.policy.v1.PolicyHub.GetBundle:input_type -> cnspec.policy.v1.Mrn
	72,  // 183: cnspec.policy.v1.PolicyHub.GetPolicy:input_type -> cnspec.policy.v1.Mrn
	72,  // 184: cnspec.policy.v1.PolicyHub.DeletePolicy:input_type -> cnspec.policy.v1.Mrn
	72,  // 185: cnspec.policy.v1.PolicyHub.GetPolicyFilters:input_type -> cnspec.policy.v1.Mrn
	74,  // 186: cnspec.policy.v1.PolicyHub.List:input_type -> cnspec.policy.v1.ListReq
	75,  // 187: cnspec.policy.v1.PolicyHub.DefaultPolicies:input_type -> cnspec.policy.v1.DefaultPoliciesReq
	72,  // 188: cnspec.policy.v1.PolicyHub.GetFramework:input_type -> cnspec.policy.v1.Mrn
	72,  // 189: cnspec.policy.v1.PolicyHub.DeleteFramework:input_type -> cnspec.policy.v1.Mrn
	74,  // 190: cnspec.policy.v1.PolicyHub.ListFrameworks:input_type -> cnspec.policy.v1.ListReq
	77,  // 191: cnspec.policy.v1.PolicyResolver.Assign:input_type -> cnspec.policy.v1.PolicyAssignment
	77,  // 192: cnspec.policy.v1.PolicyResolver.Unassign:input_type -> cnspec.policy.v1.PolicyAssignment
	144, // 193: cnspec.policy.v1.PolicyResolver.SetProps:input_type -> cnquery.explorer.PropsReq
	80,  // 194: cnspec.policy.v1.PolicyResolver.Resolve:input_type -> cnspec.policy.v1.ResolveReq
	81,  // 195: cnspec.policy.v1.PolicyResolver.UpdateAssetJobs:input_type -> cnspec.policy.v1.UpdateAssetJobsReq
	81,  // 196: cnspec.policy.v1.PolicyResolver.ResolveAndUpdateJobs:input_type -> cnspec.policy.v1.UpdateAssetJobsReq
	72,  // 197: cnspec.policy.v1.PolicyResolver.GetResolvedPolicy:input_type -> cnspec.policy.v1.Mrn
	82,  // 198: cnspec.policy.v1.PolicyResolver.StoreResults:input_type -> cnspec.policy.v1.StoreResultsReq
	83,  // 199: cnspec.policy.v1.PolicyResolver.GetUploadURL:input_type -> cnspec.policy.v1.GetUploadURLReq
	86,  // 200: cnspec.policy.v1.PolicyResolver.ReportUploadCompleted:input_type -> cnspec.policy.v1.ReportUploadCompletedReq
	87,  // 201: cnspec.policy.v1.PolicyResolver.GetReport:input_type -> cnspec.policy.v1.EntityScoreReq
	87,  // 202: cnspec.policy.v1.PolicyResolver.GetFrameworkReport:input_type -> cnspec.policy.v1.EntityScoreReq
	87,  // 203: cnspec.policy.v1.PolicyResolver.GetScore:input_type -> cnspec.policy.v1.EntityScoreReq
	145, // 204: cnspec.policy.v1.PolicyResolver.GetResourcesData:input_type -> cnquery.explorer.resources.EntityResourcesReq
	88,  // 205: cnspec.policy.v1.PolicyResolver.SynchronizeAssets:input_type -> cnspec.policy.v1.SynchronizeAssetsReq
	91,  // 206: cnspec.policy.v1.PolicyResolver.PurgeAssets:input_type -> cnspec.policy.v1.PurgeAssetsRequest
	71,  // 207: cnspec.policy.v1.PolicyHub.SetBundle:output_type -> cnspec.policy.v1.Empty
	71,  // 208: cnspec.policy.v1.PolicyHub.ValidateBundle:output_type -> cnspec.policy.v1.Empty
	20,  // 209: cnspec.policy.v1.PolicyHub.GetBundle:output_type -> cnspec.policy.v1.Bundle
	16,  // 210: cnspec.policy.v1.PolicyHub.GetPolicy:output_type -> cnspec.policy.v1.Policy
	71,  // 211: cnspec.policy.v1.PolicyHub.DeletePolicy:output_type -> cnspec.policy.v1.Empty
	73,  // 212: cnspec.policy.v1.PolicyHub.GetPolicyFilters:output_type -> cnspec.policy.v1.Mqueries
	17,  // 213: cnspec.policy.v1.PolicyHub.List:output_type -> cnspec.policy.v1.Policies
	76,  // 214: cnspec.policy.v1.PolicyHub.DefaultPolicies:output_type -> cnspec.policy.v1.URLs
	36,  // 215: cnspec.policy.v1.PolicyHub.GetFramework:output_type -> cnspec.policy.v1.Framework
	71,  // 216: cnspec.policy.v1.PolicyHub.DeleteFramework:output_type -> cnspec.policy.v1.Empty
	37,  // 217: cnspec.policy.v1.PolicyHub.ListFrameworks:output_type -> cnspec.policy.v1.Frameworks
	71,  // 218: cnspec.policy.v1.PolicyResolver.Assign:output_type -> cnspec.policy.v1.Empty
	71,  // 219: cnspec.policy.v1.PolicyResolver.Unassign:output_type -> cnspec.policy.v1.Empty
	146, // 220: cnspec.policy.v1.PolicyResolver.SetProps:output_type -> cnquery.explorer.Empty
	47,  // 221: cnspec.policy.v1.PolicyResolver.Resolve:output_type -> cnspec.policy.v1.ResolvedPolicy
	71,  // 222: cnspec.policy.v1.PolicyResolver.UpdateAssetJobs:output_type -> cnspec.policy.v1.Empty
	47,  // 223: cnspec.policy.v1.PolicyResolver.ResolveAndUpdateJobs:output_type -> cnspec.policy.v1.ResolvedPolicy
	47,  // 224: cnspec.policy.v1.PolicyResolver.GetResolvedPolicy:output_type -> cnspec.policy.v1.ResolvedPolicy
	71,  // 225: cnspec.policy.v1.PolicyResolver.StoreResults:output_type -> cnspec.policy.v1.Empty
	84,  // 226: cnspec.policy.v1.PolicyResolver.GetUploadURL:output_type -> cnspec.policy.v1.GetUploadURLResp
	71,  // 227: cnspec.policy.v1.PolicyResolver.ReportUploadCompleted:output_type -> cnspec.policy.v1.Empty
	54,  // 228: cnspec.policy.v1.PolicyResolver.GetReport:output_type -> cnspec.policy.v1.Report
	57,  // 229: cnspec.policy.v1.PolicyResolver.GetFrameworkReport:output_type -> cnspec.policy.v1.FrameworkReport
	54,  // 230: cnspec.policy.v1.PolicyResolver.GetScore:output_type -> cnspec.policy.v1.Report
	147, // 231: cnspec.policy.v1.PolicyResolver.GetResourcesData:output_type -> cnquery.explorer.resources.EntityResourcesRes
	90,  // 232: cnspec.policy.v1.PolicyResolver.SynchronizeAssets:output_type -> cnspec.policy.v1.SynchronizeAssetsResp
	93,  // 233: cnspec.policy.v1.PolicyResolver.PurgeAssets:output_type -> cnspec.policy.v1.PurgeAssetsConfirmation
	207, // [207:234] is the sub-list for method output_type
	180, // [180:207] is the sub-list for method input_type
