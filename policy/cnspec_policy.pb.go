...
var (
	file_cnspec_policy_proto_enumTypes = make([]protoimpl.EnumInfo, 15)
	file_cnspec_policy_proto_msgTypes  = make([]protoimpl.MessageInfo, 150)
	file_cnspec_policy_proto_goTypes   = []any{
