...
func (Source_Vendor) EnumDescriptor() ([]byte, []int) {
	return file_cnspec_policy_proto_rawDescGZIP(), []int{77, 0}
}
...
var file_cnspec_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 107)
var file_cnspec_policy_proto_goTypes = []any{
	...
	(*QueryCounts)(nil),                         // 18: cnspec.policy.v1.QueryCounts
	(*Bundle)(nil),                              // 19: cnspec.policy.v1.Bundle
	(*MigrationGroup)(nil),                      // 20: cnspec.policy.v1.MigrationGroup
	(*Migration)(nil),                           // 21: cnspec.policy.v1.Migration
	(*MigrationMatch)(nil),                      // 22: cnspec.policy.v1.MigrationMatch
	(*MigrationDelta)(nil),                      // 23: cnspec.policy.v1.MigrationDelta
	(*SoftwareSelector)(nil),                    // 24: cnspec.policy.v1.SoftwareSelector
	(*ResourceSelector)(nil),                    // 25: cnspec.policy.v1.ResourceSelector
	(*RiskMagnitude)(nil),                       // 26: cnspec.policy.v1.RiskMagnitude
	(*RiskFactor)(nil),                          // 27: cnspec.policy.v1.RiskFactor
	(*RiskFactorDocs)(nil),                      // 28: cnspec.policy.v1.RiskFactorDocs
	(*PolicyGroupDocs)(nil),                     // 29: cnspec.policy.v1.PolicyGroupDocs
	(*PolicyDocs)(nil),                          // 30: cnspec.policy.v1.PolicyDocs
	(*Framework)(nil),                           // 31: cnspec.policy.v1.Framework
	(*Frameworks)(nil),                          // 32: cnspec.policy.v1.Frameworks
	(*FrameworkGroup)(nil),                      // 33: cnspec.policy.v1.FrameworkGroup
	(*FrameworkRef)(nil),                        // 34: cnspec.policy.v1.FrameworkRef
	(*Evidence)(nil),                            // 35: cnspec.policy.v1.Evidence
	(*Control)(nil),                             // 36: cnspec.policy.v1.Control
	(*FrameworkMap)(nil),                        // 37: cnspec.policy.v1.FrameworkMap
	(*ControlMap)(nil),                          // 38: cnspec.policy.v1.ControlMap
	(*ControlDocs)(nil),                         // 39: cnspec.policy.v1.ControlDocs
	(*ControlRef)(nil),                          // 40: cnspec.policy.v1.ControlRef
	(*Asset)(nil),                               // 41: cnspec.policy.v1.Asset
	(*ResolvedPolicy)(nil),                      // 42: cnspec.policy.v1.ResolvedPolicy
	(*ExecutionJob)(nil),                        // 43: cnspec.policy.v1.ExecutionJob
	(*ExecutionQuery)(nil),                      // 44: cnspec.policy.v1.ExecutionQuery
	(*CollectorJob)(nil),                        // 45: cnspec.policy.v1.CollectorJob
	(*StringArray)(nil),                         // 46: cnspec.policy.v1.StringArray
	(*DataQueryInfo)(nil),                       // 47: cnspec.policy.v1.DataQueryInfo
	(*ReportingJob)(nil),                        // 48: cnspec.policy.v1.ReportingJob
	(*Report)(nil),                              // 49: cnspec.policy.v1.Report
	(*Reports)(nil),                             // 50: cnspec.policy.v1.Reports
	(*ReportCollection)(nil),                    // 51: cnspec.policy.v1.ReportCollection
	(*FrameworkReport)(nil),                     // 52: cnspec.policy.v1.FrameworkReport
	(*ControlScore)(nil),                        // 53: cnspec.policy.v1.ControlScore
	(*Cvss)(nil),                                // 54: cnspec.policy.v1.Cvss
	(*CvssStats)(nil),                           // 55: cnspec.policy.v1.CvssStats
	(*Score)(nil),                               // 56: cnspec.policy.v1.Score
	(*ScoreDelta)(nil),                          // 57: cnspec.policy.v1.ScoreDelta
	(*ScoredRiskFactor)(nil),                    // 58: cnspec.policy.v1.ScoredRiskFactor
	(*ScoredRiskFactors)(nil),                   // 59: cnspec.policy.v1.ScoredRiskFactors
	(*RiskFactorStats)(nil),                     // 60: cnspec.policy.v1.RiskFactorStats
	(*RiskFactorsStats)(nil),                    // 61: cnspec.policy.v1.RiskFactorsStats
	(*Stats)(nil),                               // 62: cnspec.policy.v1.Stats
	(*ScoreDistribution)(nil),                   // 63: cnspec.policy.v1.ScoreDistribution
	(*ScoreStats)(nil),                          // 64: cnspec.policy.v1.ScoreStats
	(*AssetFindingsStats)(nil),                  // 65: cnspec.policy.v1.AssetFindingsStats
	(*Empty)(nil),                               // 66: cnspec.policy.v1.Empty
	(*Mrn)(nil),                                 // 67: cnspec.policy.v1.Mrn
	(*Mqueries)(nil),                            // 68: cnspec.policy.v1.Mqueries
	(*ListReq)(nil),                             // 69: cnspec.policy.v1.ListReq
	(*DefaultPoliciesReq)(nil),                  // 70: cnspec.policy.v1.DefaultPoliciesReq
	(*URLs)(nil),                                // 71: cnspec.policy.v1.URLs
	(*PolicyAssignment)(nil),                    // 72: cnspec.policy.v1.PolicyAssignment
	(*PolicyMutationDelta)(nil),                 // 73: cnspec.policy.v1.PolicyMutationDelta
	(*PolicyDelta)(nil),                         // 74: cnspec.policy.v1.PolicyDelta
	(*ResolveReq)(nil),                          // 75: cnspec.policy.v1.ResolveReq
	(*UpdateAssetJobsReq)(nil),                  // 76: cnspec.policy.v1.UpdateAssetJobsReq
	(*StoreResultsReq)(nil),                     // 77: cnspec.policy.v1.StoreResultsReq
	(*GetUploadURLReq)(nil),                     // 78: cnspec.policy.v1.GetUploadURLReq
	(*GetUploadURLResp)(nil),                    // 79: cnspec.policy.v1.GetUploadURLResp
	(*UploadURL)(nil),                           // 80: cnspec.policy.v1.UploadURL
	(*ReportUploadCompletedReq)(nil),            // 81: cnspec.policy.v1.ReportUploadCompletedReq
	(*EntityScoreReq)(nil),                      // 82: cnspec.policy.v1.EntityScoreReq
	(*SynchronizeAssetsReq)(nil),                // 83: cnspec.policy.v1.SynchronizeAssetsReq
	(*SynchronizeAssetsRespAssetDetail)(nil),    // 84: cnspec.policy.v1.SynchronizeAssetsRespAssetDetail
	(*SynchronizeAssetsResp)(nil),               // 85: cnspec.policy.v1.SynchronizeAssetsResp
	(*PurgeAssetsRequest)(nil),                  // 86: cnspec.policy.v1.PurgeAssetsRequest
	(*DateFilter)(nil),                          // 87: cnspec.policy.v1.DateFilter
	(*PurgeAssetsConfirmation)(nil),             // 88: cnspec.policy.v1.PurgeAssetsConfirmation
	(*Sources)(nil),                             // 89: cnspec.policy.v1.Sources
	(*Source)(nil),                              // 90: cnspec.policy.v1.Source
	nil,                                         // 91: cnspec.policy.v1.Policy.TagsEntry
	nil,                                         // 92: cnspec.policy.v1.RiskFactor.TagsEntry
	nil,                                         // 93: cnspec.policy.v1.Framework.TagsEntry
	nil,                                         // 94: cnspec.policy.v1.Control.TagsEntry
	nil,                                         // 95: cnspec.policy.v1.ExecutionJob.QueriesEntry
	nil,                                         // 96: cnspec.policy.v1.ExecutionQuery.PropertiesEntry
	nil,                                         // 97: cnspec.policy.v1.CollectorJob.ReportingJobsEntry
	nil,                                         // 98: cnspec.policy.v1.CollectorJob.ReportingQueriesEntry
	nil,                                         // 99: cnspec.policy.v1.CollectorJob.DatapointsEntry
	nil,                                         // 100: cnspec.policy.v1.CollectorJob.RiskMrnsEntry
	nil,                                         // 101: cnspec.policy.v1.CollectorJob.RiskFactorsEntry
	nil,                                         // 102: cnspec.policy.v1.ReportingJob.DatapointsEntry
	nil,                                         // 103: cnspec.policy.v1.ReportingJob.ChildJobsEntry
	nil,                                         // 104: cnspec.policy.v1.Report.ScoresEntry
	nil,                                         // 105: cnspec.policy.v1.Report.DataEntry
	nil,                                         // 106: cnspec.policy.v1.Report.CvssScoresEntry
	nil,                                         // 107: cnspec.policy.v1.ReportCollection.AssetsEntry
	nil,                                         // 108: cnspec.policy.v1.ReportCollection.ReportsEntry
	nil,                                         // 109: cnspec.policy.v1.ReportCollection.ErrorsEntry
	nil,                                         // 110: cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry
	nil,                                         // 111: cnspec.policy.v1.ReportCollection.VulnReportsEntry
	nil,                                         // 112: cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry
	nil,                                         // 113: cnspec.policy.v1.StoreResultsReq.DataEntry
	nil,                                         // 114: cnspec.policy.v1.StoreResultsReq.ResourcesEntry
	nil,                                         // 115: cnspec.policy.v1.UploadURL.HeadersEntry
	nil,                                         // 116: cnspec.policy.v1.SynchronizeAssetsRespAssetDetail.AnnotationsEntry
	nil,                                         // 117: cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry
	nil,                                         // 118: cnspec.policy.v1.PurgeAssetsRequest.LabelsEntry
	nil,                                         // 119: cnspec.policy.v1.PurgeAssetsConfirmation.ErrorsEntry
	(*explorer.Mquery)(nil),                     // 120: cnquery.explorer.Mquery
	(*explorer.Filters)(nil),                    // 121: cnquery.explorer.Filters
	(*explorer.Author)(nil),                     // 122: cnquery.explorer.Author
	(*explorer.HumanTime)(nil),                  // 123: cnquery.explorer.HumanTime
	(explorer.Action)(0),                        // 124: cnquery.explorer.Action
	(*explorer.Impact)(nil),                     // 125: cnquery.explorer.Impact
	(explorer.ScoringSystem)(0),                 // 126: cnquery.explorer.ScoringSystem
	(*explorer.Property)(nil),                   // 127: cnquery.explorer.Property
	(*explorer.QueryPack)(nil),                  // 128: cnquery.explorer.QueryPack
	(*explorer.ObjectRef)(nil),                  // 129: cnquery.explorer.ObjectRef
	(*explorer.MqueryRef)(nil),                  // 130: cnquery.explorer.MqueryRef
	(*inventory.Platform)(nil),                  // 131: cnquery.providers.v1.Platform
	(*llx.CodeBundle)(nil),                      // 132: cnquery.llx.CodeBundle
	(*inventory.Asset)(nil),                     // 133: cnquery.providers.v1.Asset
	(*llx.Result)(nil),                          // 134: cnquery.llx.Result
	(*mvd.VulnReport)(nil),                      // 135: mondoo.mvd.v1.VulnReport
	(*llx.ResourceRecording)(nil),               // 136: cnquery.llx.ResourceRecording
	(*explorer.PropsReq)(nil),                   // 137: cnquery.explorer.PropsReq
	(*resources.EntityResourcesReq)(nil),        // 138: cnquery.explorer.resources.EntityResourcesReq
	(*explorer.Empty)(nil),                      // 139: cnquery.explorer.Empty
	(*resources.EntityResourcesRes)(nil),        // 140: cnquery.explorer.resources.EntityResourcesRes
}
var file_cnspec_policy_proto_depIdxs = []int32{
	...
	120, // 1: cnspec.policy.v1.PolicyGroup.checks:type_name -> cnquery.explorer.Mquery
	120, // 2: cnspec.policy.v1.PolicyGroup.queries:type_name -> cnquery.explorer.Mquery
	0,   // 3: cnspec.policy.v1.PolicyGroup.type:type_name -> cnspec.policy.v1.GroupType
	121, // 4: cnspec.policy.v1.PolicyGroup.filters:type_name -> cnquery.explorer.Filters
	14,  // 5: cnspec.policy.v1.PolicyGroup.valid:type_name -> cnspec.policy.v1.Validity
	29,  // 6: cnspec.policy.v1.PolicyGroup.docs:type_name -> cnspec.policy.v1.PolicyGroupDocs
	122, // 7: cnspec.policy.v1.PolicyGroup.authors:type_name -> cnquery.explorer.Author
	122, // 8: cnspec.policy.v1.PolicyGroup.reviewers:type_name -> cnquery.explorer.Author
	3,   // 9: cnspec.policy.v1.PolicyGroup.review_status:type_name -> cnspec.policy.v1.ReviewStatus
	123, // 10: cnspec.policy.v1.Validity.from:type_name -> cnquery.explorer.HumanTime
	123, // 11: cnspec.policy.v1.Validity.until:type_name -> cnquery.explorer.HumanTime
	124, // 12: cnspec.policy.v1.PolicyRef.action:type_name -> cnquery.explorer.Action
	125, // 13: cnspec.policy.v1.PolicyRef.impact:type_name -> cnquery.explorer.Impact
	126, // 14: cnspec.policy.v1.PolicyRef.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	13,  // 15: cnspec.policy.v1.Policy.groups:type_name -> cnspec.policy.v1.PolicyGroup
	30,  // 16: cnspec.policy.v1.Policy.docs:type_name -> cnspec.policy.v1.PolicyDocs
	126, // 17: cnspec.policy.v1.Policy.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	122, // 18: cnspec.policy.v1.Policy.authors:type_name -> cnquery.explorer.Author
	91,  // 19: cnspec.policy.v1.Policy.tags:type_name -> cnspec.policy.v1.Policy.TagsEntry
	127, // 20: cnspec.policy.v1.Policy.props:type_name -> cnquery.explorer.Property
	27,  // 21: cnspec.policy.v1.Policy.risk_factors:type_name -> cnspec.policy.v1.RiskFactor
	121, // 22: cnspec.policy.v1.Policy.computed_filters:type_name -> cnquery.explorer.Filters
	18,  // 23: cnspec.policy.v1.Policy.query_counts:type_name -> cnspec.policy.v1.QueryCounts
	16,  // 24: cnspec.policy.v1.Policies.items:type_name -> cnspec.policy.v1.Policy
	16,  // 25: cnspec.policy.v1.Bundle.policies:type_name -> cnspec.policy.v1.Policy
	128, // 26: cnspec.policy.v1.Bundle.packs:type_name -> cnquery.explorer.QueryPack
	127, // 27: cnspec.policy.v1.Bundle.props:type_name -> cnquery.explorer.Property
	120, // 28: cnspec.policy.v1.Bundle.queries:type_name -> cnquery.explorer.Mquery
	31,  // 29: cnspec.policy.v1.Bundle.frameworks:type_name -> cnspec.policy.v1.Framework
	37,  // 30: cnspec.policy.v1.Bundle.framework_maps:type_name -> cnspec.policy.v1.FrameworkMap
	30,  // 31: cnspec.policy.v1.Bundle.docs:type_name -> cnspec.policy.v1.PolicyDocs
	20,  // 32: cnspec.policy.v1.Bundle.migration_groups:type_name -> cnspec.policy.v1.MigrationGroup
	16,  // 33: cnspec.policy.v1.MigrationGroup.policy:type_name -> cnspec.policy.v1.Policy
	21,  // 34: cnspec.policy.v1.MigrationGroup.migrations:type_name -> cnspec.policy.v1.Migration
	22,  // 35: cnspec.policy.v1.Migration.match:type_name -> cnspec.policy.v1.MigrationMatch
	23,  // 36: cnspec.policy.v1.Migration.target:type_name -> cnspec.policy.v1.MigrationDelta
	9,   // 37: cnspec.policy.v1.Migration.action:type_name -> cnspec.policy.v1.Migration.Action
	28,  // 38: cnspec.policy.v1.RiskFactor.docs:type_name -> cnspec.policy.v1.RiskFactorDocs
	121, // 39: cnspec.policy.v1.RiskFactor.filters:type_name -> cnquery.explorer.Filters
	120, // 40: cnspec.policy.v1.RiskFactor.checks:type_name -> cnquery.explorer.Mquery
	2,   // 41: cnspec.policy.v1.RiskFactor.scope:type_name -> cnspec.policy.v1.ScopeType
	26,  // 42: cnspec.policy.v1.RiskFactor.magnitude:type_name -> cnspec.policy.v1.RiskMagnitude
	24,  // 43: cnspec.policy.v1.RiskFactor.software:type_name -> cnspec.policy.v1.SoftwareSelector
	25,  // 44: cnspec.policy.v1.RiskFactor.resources:type_name -> cnspec.policy.v1.ResourceSelector
	124, // 45: cnspec.policy.v1.RiskFactor.action:type_name -> cnquery.explorer.Action
	92,  // 46: cnspec.policy.v1.RiskFactor.tags:type_name -> cnspec.policy.v1.RiskFactor.TagsEntry
	33,  // 47: cnspec.policy.v1.Framework.groups:type_name -> cnspec.policy.v1.FrameworkGroup
	30,  // 48: cnspec.policy.v1.Framework.docs:type_name -> cnspec.policy.v1.PolicyDocs
	122, // 49: cnspec.policy.v1.Framework.authors:type_name -> cnquery.explorer.Author
	93,  // 50: cnspec.policy.v1.Framework.tags:type_name -> cnspec.policy.v1.Framework.TagsEntry
	34,  // 51: cnspec.policy.v1.Framework.dependencies:type_name -> cnspec.policy.v1.FrameworkRef
	37,  // 52: cnspec.policy.v1.Framework.framework_maps:type_name -> cnspec.policy.v1.FrameworkMap
	31,  // 53: cnspec.policy.v1.Frameworks.items:type_name -> cnspec.policy.v1.Framework
	36,  // 54: cnspec.policy.v1.FrameworkGroup.controls:type_name -> cnspec.policy.v1.Control
	0,   // 55: cnspec.policy.v1.FrameworkGroup.type:type_name -> cnspec.policy.v1.GroupType
	29,  // 56: cnspec.policy.v1.FrameworkGroup.docs:type_name -> cnspec.policy.v1.PolicyGroupDocs
	122, // 57: cnspec.policy.v1.FrameworkGroup.authors:type_name -> cnquery.explorer.Author
	122, // 58: cnspec.policy.v1.FrameworkGroup.reviewers:type_name -> cnquery.explorer.Author
	3,   // 59: cnspec.policy.v1.FrameworkGroup.review_status:type_name -> cnspec.policy.v1.ReviewStatus
	124, // 60: cnspec.policy.v1.FrameworkRef.action:type_name -> cnquery.explorer.Action
	120, // 61: cnspec.policy.v1.Evidence.checks:type_name -> cnquery.explorer.Mquery
	120, // 62: cnspec.policy.v1.Evidence.queries:type_name -> cnquery.explorer.Mquery
	40,  // 63: cnspec.policy.v1.Evidence.controls:type_name -> cnspec.policy.v1.ControlRef
	39,  // 64: cnspec.policy.v1.Control.docs:type_name -> cnspec.policy.v1.ControlDocs
	94,  // 65: cnspec.policy.v1.Control.tags:type_name -> cnspec.policy.v1.Control.TagsEntry
	124, // 66: cnspec.policy.v1.Control.action:type_name -> cnquery.explorer.Action
	35,  // 67: cnspec.policy.v1.Control.evidence:type_name -> cnspec.policy.v1.Evidence
	129, // 68: cnspec.policy.v1.FrameworkMap.framework_dependencies:type_name -> cnquery.explorer.ObjectRef
	129, // 69: cnspec.policy.v1.FrameworkMap.policy_dependencies:type_name -> cnquery.explorer.ObjectRef
	129, // 70: cnspec.policy.v1.FrameworkMap.query_pack_dependencies:type_name -> cnquery.explorer.ObjectRef
	38,  // 71: cnspec.policy.v1.FrameworkMap.controls:type_name -> cnspec.policy.v1.ControlMap
	129, // 72: cnspec.policy.v1.FrameworkMap.framework_owner:type_name -> cnquery.explorer.ObjectRef
	40,  // 73: cnspec.policy.v1.ControlMap.checks:type_name -> cnspec.policy.v1.ControlRef
	40,  // 74: cnspec.policy.v1.ControlMap.policies:type_name -> cnspec.policy.v1.ControlRef
	40,  // 75: cnspec.policy.v1.ControlMap.controls:type_name -> cnspec.policy.v1.ControlRef
	40,  // 76: cnspec.policy.v1.ControlMap.queries:type_name -> cnspec.policy.v1.ControlRef
	130, // 77: cnspec.policy.v1.ControlDocs.refs:type_name -> cnquery.explorer.MqueryRef
	124, // 78: cnspec.policy.v1.ControlRef.action:type_name -> cnquery.explorer.Action
	131, // 79: cnspec.policy.v1.Asset.platform:type_name -> cnquery.providers.v1.Platform
	43,  // 80: cnspec.policy.v1.ResolvedPolicy.execution_job:type_name -> cnspec.policy.v1.ExecutionJob
	45,  // 81: cnspec.policy.v1.ResolvedPolicy.collector_job:type_name -> cnspec.policy.v1.CollectorJob
	120, // 82: cnspec.policy.v1.ResolvedPolicy.filters:type_name -> cnquery.explorer.Mquery
	4,   // 83: cnspec.policy.v1.ResolvedPolicy.features:type_name -> cnspec.policy.v1.ServerFeature
	95,  // 84: cnspec.policy.v1.ExecutionJob.queries:type_name -> cnspec.policy.v1.ExecutionJob.QueriesEntry
	96,  // 85: cnspec.policy.v1.ExecutionQuery.properties:type_name -> cnspec.policy.v1.ExecutionQuery.PropertiesEntry
	132, // 86: cnspec.policy.v1.ExecutionQuery.code:type_name -> cnquery.llx.CodeBundle
	97,  // 87: cnspec.policy.v1.CollectorJob.reporting_jobs:type_name -> cnspec.policy.v1.CollectorJob.ReportingJobsEntry
	98,  // 88: cnspec.policy.v1.CollectorJob.reporting_queries:type_name -> cnspec.policy.v1.CollectorJob.ReportingQueriesEntry
	99,  // 89: cnspec.policy.v1.CollectorJob.datapoints:type_name -> cnspec.policy.v1.CollectorJob.DatapointsEntry
	100, // 90: cnspec.policy.v1.CollectorJob.risk_mrns:type_name -> cnspec.policy.v1.CollectorJob.RiskMrnsEntry
	101, // 91: cnspec.policy.v1.CollectorJob.risk_factors:type_name -> cnspec.policy.v1.CollectorJob.RiskFactorsEntry
	126, // 92: cnspec.policy.v1.ReportingJob.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	102, // 93: cnspec.policy.v1.ReportingJob.datapoints:type_name -> cnspec.policy.v1.ReportingJob.DatapointsEntry
	103, // 94: cnspec.policy.v1.ReportingJob.child_jobs:type_name -> cnspec.policy.v1.ReportingJob.ChildJobsEntry
	10,  // 95: cnspec.policy.v1.ReportingJob.type:type_name -> cnspec.policy.v1.ReportingJob.Type
	56,  // 96: cnspec.policy.v1.Report.score:type_name -> cnspec.policy.v1.Score
	104, // 97: cnspec.policy.v1.Report.scores:type_name -> cnspec.policy.v1.Report.ScoresEntry
	105, // 98: cnspec.policy.v1.Report.data:type_name -> cnspec.policy.v1.Report.DataEntry
	62,  // 99: cnspec.policy.v1.Report.stats:type_name -> cnspec.policy.v1.Stats
	59,  // 100: cnspec.policy.v1.Report.risks:type_name -> cnspec.policy.v1.ScoredRiskFactors
	62,  // 101: cnspec.policy.v1.Report.ignored_stats:type_name -> cnspec.policy.v1.Stats
	54,  // 102: cnspec.policy.v1.Report.cvss_score:type_name -> cnspec.policy.v1.Cvss
	106, // 103: cnspec.policy.v1.Report.cvss_scores:type_name -> cnspec.policy.v1.Report.CvssScoresEntry
	55,  // 104: cnspec.policy.v1.Report.cvss_stats:type_name -> cnspec.policy.v1.CvssStats
	49,  // 105: cnspec.policy.v1.Reports.reports:type_name -> cnspec.policy.v1.Report
	107, // 106: cnspec.policy.v1.ReportCollection.assets:type_name -> cnspec.policy.v1.ReportCollection.AssetsEntry
	19,  // 107: cnspec.policy.v1.ReportCollection.bundle:type_name -> cnspec.policy.v1.Bundle
	108, // 108: cnspec.policy.v1.ReportCollection.reports:type_name -> cnspec.policy.v1.ReportCollection.ReportsEntry
	109, // 109: cnspec.policy.v1.ReportCollection.errors:type_name -> cnspec.policy.v1.ReportCollection.ErrorsEntry
	110, // 110: cnspec.policy.v1.ReportCollection.resolved_policies:type_name -> cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry
	111, // 111: cnspec.policy.v1.ReportCollection.vuln_reports:type_name -> cnspec.policy.v1.ReportCollection.VulnReportsEntry
	53,  // 112: cnspec.policy.v1.FrameworkReport.score:type_name -> cnspec.policy.v1.ControlScore
	53,  // 113: cnspec.policy.v1.FrameworkReport.controls:type_name -> cnspec.policy.v1.ControlScore
	53,  // 114: cnspec.policy.v1.ControlScore.assets:type_name -> cnspec.policy.v1.ControlScore
	63,  // 115: cnspec.policy.v1.ControlScore.scores:type_name -> cnspec.policy.v1.ScoreDistribution
	59,  // 116: cnspec.policy.v1.Score.risk_factors:type_name -> cnspec.policy.v1.ScoredRiskFactors
	90,  // 117: cnspec.policy.v1.Score.source:type_name -> cnspec.policy.v1.Source
	89,  // 118: cnspec.policy.v1.Score.sources:type_name -> cnspec.policy.v1.Sources
	58,  // 119: cnspec.policy.v1.ScoredRiskFactors.items:type_name -> cnspec.policy.v1.ScoredRiskFactor
	60,  // 120: cnspec.policy.v1.RiskFactorsStats.items:type_name -> cnspec.policy.v1.RiskFactorStats
	63,  // 121: cnspec.policy.v1.Stats.failed:type_name -> cnspec.policy.v1.ScoreDistribution
	63,  // 122: cnspec.policy.v1.Stats.passed:type_name -> cnspec.policy.v1.ScoreDistribution
	63,  // 123: cnspec.policy.v1.Stats.errors:type_name -> cnspec.policy.v1.ScoreDistribution
	64,  // 124: cnspec.policy.v1.AssetFindingsStats.score_stats:type_name -> cnspec.policy.v1.ScoreStats
	61,  // 125: cnspec.policy.v1.AssetFindingsStats.risk_factors:type_name -> cnspec.policy.v1.RiskFactorsStats
	120, // 126: cnspec.policy.v1.Mqueries.items:type_name -> cnquery.explorer.Mquery
	124, // 127: cnspec.policy.v1.PolicyAssignment.action:type_name -> cnquery.explorer.Action
	126, // 128: cnspec.policy.v1.PolicyAssignment.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	112, // 129: cnspec.policy.v1.PolicyMutationDelta.policy_deltas:type_name -> cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry
	124, // 130: cnspec.policy.v1.PolicyMutationDelta.action:type_name -> cnquery.explorer.Action
	11,  // 131: cnspec.policy.v1.PolicyDelta.action:type_name -> cnspec.policy.v1.PolicyDelta.PolicyAssignmentActionType
	126, // 132: cnspec.policy.v1.PolicyDelta.scoring_system:type_name -> cnquery.explorer.ScoringSystem
	120, // 133: cnspec.policy.v1.ResolveReq.asset_filters:type_name -> cnquery.explorer.Mquery
	120, // 134: cnspec.policy.v1.UpdateAssetJobsReq.asset_filters:type_name -> cnquery.explorer.Mquery
	56,  // 135: cnspec.policy.v1.StoreResultsReq.scores:type_name -> cnspec.policy.v1.Score
	113, // 136: cnspec.policy.v1.StoreResultsReq.data:type_name -> cnspec.policy.v1.StoreResultsReq.DataEntry
	114, // 137: cnspec.policy.v1.StoreResultsReq.resources:type_name -> cnspec.policy.v1.StoreResultsReq.ResourcesEntry
	58,  // 138: cnspec.policy.v1.StoreResultsReq.risks:type_name -> cnspec.policy.v1.ScoredRiskFactor
	54,  // 139: cnspec.policy.v1.StoreResultsReq.cvssScores:type_name -> cnspec.policy.v1.Cvss
	5,   // 140: cnspec.policy.v1.GetUploadURLReq.kind:type_name -> cnspec.policy.v1.UploadURLKind
	80,  // 141: cnspec.policy.v1.GetUploadURLResp.upload_url:type_name -> cnspec.policy.v1.UploadURL
	115, // 142: cnspec.policy.v1.UploadURL.headers:type_name -> cnspec.policy.v1.UploadURL.HeadersEntry
	133, // 143: cnspec.policy.v1.SynchronizeAssetsReq.list:type_name -> cnquery.providers.v1.Asset
	116, // 144: cnspec.policy.v1.SynchronizeAssetsRespAssetDetail.annotations:type_name -> cnspec.policy.v1.SynchronizeAssetsRespAssetDetail.AnnotationsEntry
	117, // 145: cnspec.policy.v1.SynchronizeAssetsResp.details:type_name -> cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry
	87,  // 146: cnspec.policy.v1.PurgeAssetsRequest.date_filter:type_name -> cnspec.policy.v1.DateFilter
	118, // 147: cnspec.policy.v1.PurgeAssetsRequest.labels:type_name -> cnspec.policy.v1.PurgeAssetsRequest.LabelsEntry
	7,   // 148: cnspec.policy.v1.DateFilter.comparison:type_name -> cnspec.policy.v1.Comparison
	8,   // 149: cnspec.policy.v1.DateFilter.field:type_name -> cnspec.policy.v1.DateFilterField
	119, // 150: cnspec.policy.v1.PurgeAssetsConfirmation.errors:type_name -> cnspec.policy.v1.PurgeAssetsConfirmation.ErrorsEntry
	90,  // 151: cnspec.policy.v1.Sources.items:type_name -> cnspec.policy.v1.Source
	12,  // 152: cnspec.policy.v1.Source.vendor:type_name -> cnspec.policy.v1.Source.Vendor
	44,  // 153: cnspec.policy.v1.ExecutionJob.QueriesEntry.value:type_name -> cnspec.policy.v1.ExecutionQuery
	48,  // 154: cnspec.policy.v1.CollectorJob.ReportingJobsEntry.value:type_name -> cnspec.policy.v1.ReportingJob
	46,  // 155: cnspec.policy.v1.CollectorJob.ReportingQueriesEntry.value:type_name -> cnspec.policy.v1.StringArray
	47,  // 156: cnspec.policy.v1.CollectorJob.DatapointsEntry.value:type_name -> cnspec.policy.v1.DataQueryInfo
	46,  // 157: cnspec.policy.v1.CollectorJob.RiskMrnsEntry.value:type_name -> cnspec.policy.v1.StringArray
	27,  // 158: cnspec.policy.v1.CollectorJob.RiskFactorsEntry.value:type_name -> cnspec.policy.v1.RiskFactor
	125, // 159: cnspec.policy.v1.ReportingJob.ChildJobsEntry.value:type_name -> cnquery.explorer.Impact
	56,  // 160: cnspec.policy.v1.Report.ScoresEntry.value:type_name -> cnspec.policy.v1.Score
	134, // 161: cnspec.policy.v1.Report.DataEntry.value:type_name -> cnquery.llx.Result
	54,  // 162: cnspec.policy.v1.Report.CvssScoresEntry.value:type_name -> cnspec.policy.v1.Cvss
	133, // 163: cnspec.policy.v1.ReportCollection.AssetsEntry.value:type_name -> cnquery.providers.v1.Asset
	49,  // 164: cnspec.policy.v1.ReportCollection.ReportsEntry.value:type_name -> cnspec.policy.v1.Report
	42,  // 165: cnspec.policy.v1.ReportCollection.ResolvedPoliciesEntry.value:type_name -> cnspec.policy.v1.ResolvedPolicy
	135, // 166: cnspec.policy.v1.ReportCollection.VulnReportsEntry.value:type_name -> mondoo.mvd.v1.VulnReport
	74,  // 167: cnspec.policy.v1.PolicyMutationDelta.PolicyDeltasEntry.value:type_name -> cnspec.policy.v1.PolicyDelta
	134, // 168: cnspec.policy.v1.StoreResultsReq.DataEntry.value:type_name -> cnquery.llx.Result
	136, // 169: cnspec.policy.v1.StoreResultsReq.ResourcesEntry.value:type_name -> cnquery.llx.ResourceRecording
	84,  // 170: cnspec.policy.v1.SynchronizeAssetsResp.DetailsEntry.value:type_name -> cnspec.policy.v1.SynchronizeAssetsRespAssetDetail
	19,  // 171: cnspec.policy.v1.PolicyHub.SetBundle:input_type -> cnspec.policy.v1.Bundle
	19,  // 172: cnspec.policy.v1.PolicyHub.ValidateBundle:input_type -> cnspec.policy.v1.Bundle
	67,  // 173: cnspec.policy.v1.PolicyHub.GetBundle:input_type -> cnspec.policy.v1.Mrn
	67,  // 174: cnspec.policy.v1.PolicyHub.GetPolicy:input_type -> cnspec.policy.v1.Mrn
	67,  // 175: cnspec.policy.v1.PolicyHub.DeletePolicy:input_type -> cnspec.policy.v1.Mrn
	67,  // 176: cnspec.policy.v1.PolicyHub.GetPolicyFilters:input_type -> cnspec.policy.v1.Mrn
	69,  // 177: cnspec.policy.v1.PolicyHub.List:input_type -> cnspec.policy.v1.ListReq
	70,  // 178: cnspec.policy.v1.PolicyHub.DefaultPolicies:input_type -> cnspec.policy.v1.DefaultPoliciesReq
	67,  // 179: cnspec.policy.v1.PolicyHub.GetFramework:input_type -> cnspec.policy.v1.Mrn
	67,  // 180: cnspec.policy.v1.PolicyHub.DeleteFramework:input_type -> cnspec.policy.v1.Mrn
	69,  // 181: cnspec.policy.v1.PolicyHub.ListFrameworks:input_type -> cnspec.policy.v1.ListReq
	72,  // 182: cnspec.policy.v1.PolicyResolver.Assign:input_type -> cnspec.policy.v1.PolicyAssignment
	72,  // 183: cnspec.policy.v1.PolicyResolver.Unassign:input_type -> cnspec.policy.v1.PolicyAssignment
	137, // 184: cnspec.policy.v1.PolicyResolver.SetProps:input_type -> cnquery.explorer.PropsReq
	75,  // 185: cnspec.policy.v1.PolicyResolver.Resolve:input_type -> cnspec.policy.v1.ResolveReq
	76,  // 186: cnspec.policy.v1.PolicyResolver.UpdateAssetJobs:input_type -> cnspec.policy.v1.UpdateAssetJobsReq
	76,  // 187: cnspec.policy.v1.PolicyResolver.ResolveAndUpdateJobs:input_type -> cnspec.policy.v1.UpdateAssetJobsReq
	67,  // 188: cnspec.policy.v1.PolicyResolver.GetResolvedPolicy:input_type -> cnspec.policy.v1.Mrn
	77,  // 189: cnspec.policy.v1.PolicyResolver.StoreResults:input_type -> cnspec.policy.v1.StoreResultsReq
	78,  // 190: cnspec.policy.v1.PolicyResolver.GetUploadURL:input_type -> cnspec.policy.v1.GetUploadURLReq
	81,  // 191: cnspec.policy.v1.PolicyResolver.ReportUploadCompleted:input_type -> cnspec.policy.v1.ReportUploadCompletedReq
	82,  // 192: cnspec.policy.v1.PolicyResolver.GetReport:input_type -> cnspec.policy.v1.EntityScoreReq
	82,  // 193: cnspec.policy.v1.PolicyResolver.GetFrameworkReport:input_type -> cnspec.policy.v1.EntityScoreReq
	82,  // 194: cnspec.policy.v1.PolicyResolver.GetScore:input_type -> cnspec.policy.v1.EntityScoreReq
	138, // 195: cnspec.policy.v1.PolicyResolver.GetResourcesData:input_type -> cnquery.explorer.resources.EntityResourcesReq
	83,  // 196: cnspec.policy.v1.PolicyResolver.SynchronizeAssets:input_type -> cnspec.policy.v1.SynchronizeAssetsReq
	86,  // 197: cnspec.policy.v1.PolicyResolver.PurgeAssets:input_type -> cnspec.policy.v1.PurgeAssetsRequest
	66,  // 198: cnspec.policy.v1.PolicyHub.SetBundle:output_type -> cnspec.policy.v1.Empty
	66,  // 199: cnspec.policy.v1.PolicyHub.ValidateBundle:output_type -> cnspec.policy.v1.Empty
	19,  // 200: cnspec.policy.v1.PolicyHub.GetBundle:output_type -> cnspec.policy.v1.Bundle
	16,  // 201: cnspec.policy.v1.PolicyHub.GetPolicy:output_type -> cnspec.policy.v1.Policy
	66,  // 202: cnspec.policy.v1.PolicyHub.DeletePolicy:output_type -> cnspec.policy.v1.Empty
	68,  // 203: cnspec.policy.v1.PolicyHub.GetPolicyFilters:output_type -> cnspec.policy.v1.Mqueries
	17,  // 204: cnspec.policy.v1.PolicyHub.List:output_type -> cnspec.policy.v1.Policies
	71,  // 205: cnspec.policy.v1.PolicyHub.DefaultPolicies:output_type -> cnspec.policy.v1.URLs
	31,  // 206: cnspec.policy.v1.PolicyHub.GetFramework:output_type -> cnspec.policy.v1.Framework
	66,  // 207: cnspec.policy.v1.PolicyHub.DeleteFramework:output_type -> cnspec.policy.v1.Empty
	32,  // 208: cnspec.policy.v1.PolicyHub.ListFrameworks:output_type -> cnspec.policy.v1.Frameworks
	66,  // 209: cnspec.policy.v1.PolicyResolver.Assign:output_type -> cnspec.policy.v1.Empty
	66,  // 210: cnspec.policy.v1.PolicyResolver.Unassign:output_type -> cnspec.policy.v1.Empty
	139, // 211: cnspec.policy.v1.PolicyResolver.SetProps:output_type -> cnquery.explorer.Empty
	42,  // 212: cnspec.policy.v1.PolicyResolver.Resolve:output_type -> cnspec.policy.v1.ResolvedPolicy
	66,  // 213: cnspec.policy.v1.PolicyResolver.UpdateAssetJobs:output_type -> cnspec.policy.v1.Empty
	42,  // 214: cnspec.policy.v1.PolicyResolver.ResolveAndUpdateJobs:output_type -> cnspec.policy.v1.ResolvedPolicy
	42,  // 215: cnspec.policy.v1.PolicyResolver.GetResolvedPolicy:output_type -> cnspec.policy.v1.ResolvedPolicy
	66,  // 216: cnspec.policy.v1.PolicyResolver.StoreResults:output_type -> cnspec.policy.v1.Empty
	79,  // 217: cnspec.policy.v1.PolicyResolver.GetUploadURL:output_type -> cnspec.policy.v1.GetUploadURLResp
	66,  // 218: cnspec.policy.v1.PolicyResolver.ReportUploadCompleted:output_type -> cnspec.policy.v1.Empty
	49,  // 219: cnspec.policy.v1.PolicyResolver.GetReport:output_type -> cnspec.policy.v1.Report
	52,  // 220: cnspec.policy.v1.PolicyResolver.GetFrameworkReport:output_type -> cnspec.policy.v1.FrameworkReport
	49,  // 221: cnspec.policy.v1.PolicyResolver.GetScore:output_type -> cnspec.policy.v1.Report
	140, // 222: cnspec.policy.v1.PolicyResolver.GetResourcesData:output_type -> cnquery.explorer.resources.EntityResourcesRes
	85,  // 223: cnspec.policy.v1.PolicyResolver.SynchronizeAssets:output_type -> cnspec.policy.v1.SynchronizeAssetsResp
	88,  // 224: cnspec.policy.v1.PolicyResolver.PurgeAssets:output_type -> cnspec.policy.v1.PurgeAssetsConfirmation
