...
func TestScoreDistributionAdd(t *testing.T) {
	...
	scoreDist.Add(&policy.Score{Value: 61, Type: policy.ScoreType_Result, ScoreCompletion: 100})
	...
	scoreDist.Add(&policy.Score{Value: 31, Type: policy.ScoreType_Result, ScoreCompletion: 100})
	...
	scoreDist.Add(&policy.Score{Value: 11, Type: policy.ScoreType_Result, ScoreCompletion: 100})
...
func TestScoreDistributionRemove(t *testing.T) {
	...
	scoreDist.Remove(&policy.Score{Value: 61, Type: policy.ScoreType_Result, ScoreCompletion: 100})
	...
	scoreDist.Remove(&policy.Score{Value: 31, Type: policy.ScoreType_Result, ScoreCompletion: 100})
	...
	scoreDist.Remove(&policy.Score{Value: 11, Type: policy.ScoreType_Result, ScoreCompletion: 100})
