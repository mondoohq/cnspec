...
const file_scan_proto_rawDesc = "" +
	...
	"\vHealthCheck\x12&.cnspec.policy.scan.HealthCheckRequest\x1a'.cnspec.policy.scan.HealthCheckResponse\"\x00B&Z$go.mondoo.com/cnspec/v13/policy/scanb\x06proto3"
