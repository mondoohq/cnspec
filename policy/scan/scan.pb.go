...
// then a raw ReportCollection object is returned.
...
func (x *Job) GetParallelism() int32 {
	if x != nil {
...
const file_scan_proto_rawDesc = "" +
	...
	"reportType\x12 \n" +
	"\vparallelism\x18\x18 \x01(\x05R\vparallelism\x1a8\n" +
	"\n" +
	"PropsEntry\x12\x10\n" +
	...
	"\vHealthCheck\x12&.cnspec.policy.scan.HealthCheckRequest\x1a'.cnspec.policy.scan.HealthCheckResponse\"\x00B\"Z go.mondoo.com/cnspec/policy/scanb\x06proto3"
