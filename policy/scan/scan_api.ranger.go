...
type Scan interface {
	Run(context.Context, *ScanJob) (*ScanResult, error)
	RunIncognito(context.Context, *IncognitoScanJob) (*ScanResult, error)
	Schedule(context.Context, *ScanJob) (*Empty, error)
...
func (c *ScanClient) Run(ctx context.Context, in *ScanJob) (*ScanResult, error) {
	out := new(ScanResult)
	err := c.DoClientRequest(ctx, c.httpclient, strings.Join([]string{c.prefix, "/Run"}, ""), in, out)
	return out, err
}
func (c *ScanClient) RunIncognito(ctx context.Context, in *IncognitoScanJob) (*ScanResult, error) {
	out := new(ScanResult)
	err := c.DoClientRequest(ctx, c.httpclient, strings.Join([]string{c.prefix, "/RunIncognito"}, ""), in, out)
	return out, err
}
func (c *ScanClient) Schedule(ctx context.Context, in *ScanJob) (*Empty, error) {
	out := new(Empty)
