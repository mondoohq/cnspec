...
// AllClasses is every class cnspec can emit, in write order. Classes reports the
// ones a particular set contains; this is the full set, which is what a caller
// writing per-class files needs to know about the files a run did not produce.
