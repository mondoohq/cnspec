...
resource "google_compute_disk" "bad_raw_example" {
  disk_encryption_key {
    raw_key="b2ggbm8gdGhpcyBpcyBiYWQ="
  }
}

resource "google_compute_instance" "shielded_vm_bad_1" {
  name         = "test"
  machine_type = "e2-medium"
  zone         = "us-central1-a"
...
resource "google_compute_instance" "shielded_vm_bad_2" {
  name         = "test"
  machine_type = "e2-medium"
  zone         = "us-central1-a"
...
# Check for enable-oslogin = false
...
# Check for disk_encryption_key_raw 
